...
// https://www.nayuki.io/res/qr-code-generator-library/qrcodegen.js 1.8.0
...
// https://www.nayuki.io/res/qr-code-generator-library/qrcodegen-input-demo.js 1.8.0

"use strict";var app;!function(e){function r(){var e=n("output-format-bitmap").checked,r=t("scale-row"),o=t("svg-xml-row");e?(r.style.removeProperty("display"),o.style.display="none"):(r.style.display="none",o.style.removeProperty("display"));var i=t("svg-xml-output");i.value="";var a=t("qrcode-canvas"),l=document.getElementById("qrcode-svg");a.style.display="none",l.style.display="none";var c=n("errcorlvl-medium").checked?qrcodegen.QrCode.Ecc.MEDIUM:n("errcorlvl-quartile").checked?qrcodegen.QrCode.Ecc.QUARTILE:n("errcorlvl-high").checked?qrcodegen.QrCode.Ecc.HIGH:qrcodegen.QrCode.Ecc.LOW,s=t("text-input").value,u=qrcodegen.QrSegment.makeSegments(s),d=parseInt(n("version-min-input").value,10),v=parseInt(n("version-max-input").value,10),p=parseInt(n("mask-input").value,10),g=n("boost-ecc-input").checked,m=qrcodegen.QrCode.encodeSegments(u,c,d,v,p,g),h=parseInt(n("border-input").value,10),f=n("light-color-input").value,y=n("dark-color-input").value;if(!(h<0||h>100)){if(e){var w=parseInt(n("scale-input").value,10);if(w<=0||w>30)return;!function(e,r,t,n,o,i){if(r<=0||t<0)throw new RangeError("Value out of range");var a=(e.size+2*t)*r;i.width=a,i.height=a;for(var l=i.getContext("2d"),c=-t;c<e.size+t;c++)for(var s=-t;s<e.size+t;s++)l.fillStyle=e.getModule(s,c)?o:n,l.fillRect((s+t)*r,(c+t)*r,r,r)}(m,w,h,f,y,a),a.style.removeProperty("display")}else{var E=function(e,r,t,n){if(r<0)throw new RangeError("Border must be non-negative");for(var o=[],i=0;i<e.size;i++)for(var a=0;a<e.size;a++)e.getModule(a,i)&&o.push("M"+(a+r)+","+(i+r)+"h1v1h-1z");return'<?xml version="1.0" encoding="UTF-8"?>\n<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">\n<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 '+(e.size+2*r)+" "+(e.size+2*r)+'" stroke="none">\n\t<rect width="100%" height="100%" fill="'+t+'"/>\n\t<path d="'+o.join(" ")+'" fill="'+n+'"/>\n</svg>\n'}(m,h,f,y),I=/ viewBox="([^"]*)"/.exec(E)[1],x=/ d="([^"]*)"/.exec(E)[1];l.setAttribute("viewBox",I),l.querySelector("path").setAttribute("d",x),l.querySelector("rect").setAttribute("fill",f),l.querySelector("path").setAttribute("fill",y),l.style.removeProperty("display"),i.value=E}t("statistics-output").textContent="QR Code version = "+m.version+", mask pattern = "+m.mask+", character count = "+function(e){for(var r=0,t=0;t<e.length;t++,r++){var n=e.charCodeAt(t);if(!(n<55296||n>=57344)){if(55296<=n&&n<56320&&t+1<e.length){t++;var o=e.charCodeAt(t);if(56320<=o&&o<57344)continue}throw new RangeError("Invalid UTF-16 string")}}return r}(s)+",\nencoding mode = "+function(e){if(0==e.length)return"none";if(1==e.length){var r=e[0].mode,t=qrcodegen.QrSegment.Mode;return r==t.NUMERIC?"numeric":r==t.ALPHANUMERIC?"alphanumeric":r==t.BYTE?"byte":r==t.KANJI?"kanji":"unknown"}return"multiple"}(u)+", error correction = level "+"LMQH".charAt(m.errorCorrectionLevel.ordinal)+", data bits = "+qrcodegen.QrSegment.getTotalBits(u,m.version)+"."}}function t(e){var r=document.getElementById(e);if(r instanceof HTMLElement)return r;throw new Error("Assertion error")}function n(e){var r=t(e);if(r instanceof HTMLInputElement)return r;throw new Error("Assertion error")}e.handleVersionMinMax=function(e){var t=n("version-min-input"),o=n("version-max-input"),i=parseInt(t.value,10),a=parseInt(o.value,10);i=Math.max(Math.min(i,qrcodegen.QrCode.MAX_VERSION),qrcodegen.QrCode.MIN_VERSION),a=Math.max(Math.min(a,qrcodegen.QrCode.MAX_VERSION),qrcodegen.QrCode.MIN_VERSION),"min"==e&&i>a?a=i:"max"==e&&a<i&&(i=a),t.value=i.toString(),o.value=a.toString(),r()},function(){t("loading").style.display="none",t("loaded").style.removeProperty("display");for(var e=document.querySelectorAll("input[type=number], input[type=text], textarea"),n=0,o=e;n<o.length;n++)0!=(l=o[n]).id.indexOf("version-")&&(l.oninput=r);for(var i=0,a=e=document.querySelectorAll("input[type=radio], input[type=checkbox]");i<a.length;i++){var l;(l=a[i]).onchange=r}r()}()}(app||(app={}));