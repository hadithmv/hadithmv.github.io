...
Set-Content ../quranHadithmv.js -Value 'const quran_DB='
Get-Content quranHadithmv.json | Add-Content ../quranHadithmv.js
uglifyjs ../quranHadithmv.js -c -m -o ../quranHadithmv.js
