...
const STRINGS = {
  ...
  libAuthors: { dv: "ލިޔުންތެރިން", en: "Authors", ar: "المؤلفون" },
  libPeriods: { dv: "ޒަމާންތައް", en: "Periods", ar: "الفترات" },
  libAuthorsTitle: { dv: "ލިޔުންތެރިން", en: "Browse by author", ar: "تصفح حسب المؤلف" },
  libNoAuthors: { dv: "ލިޔުންތެރިން ނެތެވެ", en: "No authors found", ar: "لا يوجد مؤلفون" },
  libPeriodsTitle: { dv: "ޒަމާންތައް", en: "Browse by period", ar: "تصفح حسب الفترة" },
  authorDied: { dv: "މަރުވި ހިޖުރީ {y}", en: "d. {y} AH", ar: "ت {y}هـ" },
  authorLife: { dv: "{b}–{d} ހިޖުރީ", en: "{b}–{d} AH", ar: "{b}–{d}هـ" },
  authorBy: { dv: "ލިޔުއްވީ", en: "by", ar: "تأليف" },
  // Hijri centuries of the author's death year (1st–15th), plus the modern bucket
  century1: { dv: "ފުރަތަމަ ގަރުނު", en: "1st century", ar: "القرن الأول" },
  century2: { dv: "ދެވަނަ ގަރުނު", en: "2nd century", ar: "القرن الثاني" },
  century3: { dv: "ތިންވަނަ ގަރުނު", en: "3rd century", ar: "القرن الثالث" },
  century4: { dv: "ހަތަރުވަނަ ގަރުނު", en: "4th century", ar: "القرن الرابع" },
  century5: { dv: "ފަސްވަނަ ގަރުނު", en: "5th century", ar: "القرن الخامس" },
  century6: { dv: "ހަވަނަ ގަރުނު", en: "6th century", ar: "القرن السادس" },
  century7: { dv: "ހަތްވަނަ ގަރުނު", en: "7th century", ar: "القرن السابع" },
  century8: { dv: "އަށްވަނަ ގަރުނު", en: "8th century", ar: "القرن الثامن" },
  century9: { dv: "ނުވަވަނަ ގަރުނު", en: "9th century", ar: "القرن التاسع" },
  century10: { dv: "ދިހަވަނަ ގަރުނު", en: "10th century", ar: "القرن العاشر" },
  century11: { dv: "އެގާރަވަނަ ގަރުނު", en: "11th century", ar: "القرن الحادي عشر" },
  century12: { dv: "ބާރަވަނަ ގަރުނު", en: "12th century", ar: "القرن الثاني عشر" },
  century13: { dv: "ތޭރަވަނަ ގަރުނު", en: "13th century", ar: "القرن الثالث عشر" },
  century14: { dv: "ސާދަވަނަ ގަރުނު", en: "14th century", ar: "القرن الرابع عشر" },
  century15: { dv: "ފަނަރަވަނަ ގަރުނު", en: "15th century", ar: "القرن الخامس عشر" },
