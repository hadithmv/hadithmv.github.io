 ...
 *
 * Run:  node data/07-rebuild-searchIndex.mjs
 *
...
console.log("gzip size:", gzipMB + " MB");
...
md += "Regenerated by `node data/07-rebuild-searchIndex.mjs` — machine output, do not hand-edit.\n\n";
md += "| Built in | Version |\n|---|---|\n";
md += "| " + new Date().toISOString() + " (" + (totalMs / 1000).toFixed(1) + " s) | `" + version + "` |\n\n";
md += "| Books | Rows | Postings | Unique words | Raw | Gzip | ExcludeColumns | Excluded books |\n";
md += "|---|---|---|---|---|---|---|---|\n";
md += "| " + fmt(booksScanned) + " | " + fmt(rowsScanned) + " | " + fmt(wordsIndexed) + " | " +
  fmt(Object.keys(words).length) + " | " + rawMB + " MiB | " + gzipMB + " MiB | " +
