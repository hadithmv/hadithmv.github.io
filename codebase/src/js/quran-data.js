 ...
 * Quran Data Module
 *
 * Pure data/logic: loading, merging, ayah decoration, structural derivation.
 * Detection + column classification now live in book-data.js (see there) so
 * this module is out of every non-QRN reader's critical path.
 *
 * Imported by quran-ui.js; reader.js lazy-loads the pair (dynamic import)
 * only when a QRN-prefixed book opens.
 */

import { fetchCSVRows, fetchBookCSVCached } from "./csv.js";
import { QRN_BASE_FILE, getBookVersionSync } from "./book-data.js";
import { currentLang } from "./i18n.js";
import { normaliseForSearch } from "./search-utils.js";

// ── Content preset definitions ──────────────────────────────
// Book codes (sourceBook from 07-registry-quranColumns.csv)
