...
| `js/book-info.js`                         | Book/author info modal **+ the books/info.html page**: markdown notes renderer, fact strip, auto-TOC, in-modal search, copy, copy-link, 4-format pane export (reuses `js/export.js`'s shared builders)                  |
