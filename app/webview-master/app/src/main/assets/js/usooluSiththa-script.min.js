$(document).ready(() => {
  ...
  const c = $("#usooluSiththaTable").DataTable({
    data: usooluSiththa_DB,
    columns: [
      {
        data: 0,
        title: "#",
      ...
      { data: 7, title: "شرح خالد المصلح" },
      { data: 8, title: "شرح العثيمين" },
    ],
    columnDefs: [
      {
        targets: [6, 8, 9],
