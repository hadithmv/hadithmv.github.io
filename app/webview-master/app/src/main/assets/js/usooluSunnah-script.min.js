$(document).ready(() => {
  ...
  const c = $("#usooluSunnahTable").DataTable({
    data: usooluSunnah_DB,
    columns: [
      {
        data: 0,
        title: "#",
      ...
      { data: 3, title: "ތަޚްރީޖު" },
      { data: 4, title: "English" },
      { data: 5, title: "شرح الجبرين" },
    ],
    columnDefs: [
      {
        targets: [4, 6],
    ...
    buttons: [
      {
        ...
        text: "ކޮޕީ",
        messageTop: "ޙަދީޘްއެމްވީ – އަޙްމަދުގެ ސުންނަތުގެ އުސޫލުތައް",
        title: "",
        customize(a) {
          a = a.replace(/\r\n\r\n|\n\n/g, " ");
          a = a.replace(/\r\n|\n/g, "\t");
