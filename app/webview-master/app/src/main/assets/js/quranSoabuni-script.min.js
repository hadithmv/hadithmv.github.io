$(document).ready(() => {
  ...
  const h = (function (a, b) {
      return Array.from({ length: Math.max(a.length, b.length) }, (c, d) =>
        [].concat(
          Array.isArray(a[d]) ? a[d] : Array(b[d].length).fill(""),
          Array.isArray(b[d]) ? b[d] : Array(a[d].length).fill("")
        )
      );
    })(surah_juz_basmalah_ayah_uthmani_DB, quran_DB),
    e = $("#quranTable").DataTable({
      data: h,
      columns: [
        {
          data: 0,
        ...
        { data: 6, title: "ރ އޮފީސް ތަރުޖަމާ" },
        { data: 7, title: "ތަފުސީރު" },
        { data: 8, title: "ނޯޓު ނަން" },
        { data: 9, title: "ނޯޓު" },
      ],
      columnDefs: [
        {
      ...
      buttons: [
        {
          ...
          text: "ކޮޕީ",
          messageTop: "ޞާބޫނީގެ ބަޔާންވެގެންވާ ފަސޭހަ ތަފްސީރު",
          title: "",
          customize(a) {
            a = a.replace(/\r\n|\n/g, "\t");
            ...
            a = a.replace(/ރ އޮފީސް ތަރުޖަމާ\t/g, "");
            a = a.replace(/ތަފުސީރު\t/g, "");
            a = a.replace(/ނޯޓު ނަން\t/g, "");
            a = a.replace(/ނޯޓު\t/g, "");
            a = a.replace(
              /‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\t/g,
              "\n\n‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\n"
