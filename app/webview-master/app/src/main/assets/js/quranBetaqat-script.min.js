$(document).ready(() => {
  ...
  for (var d = 1; d < quran_DB.length; d++)
    if ("" === quran_DB[d][0]) {
      let a = d - 1;
      for (; 0 <= a && "" === quran_DB[a][0]; ) a--;
      0 <= a && (quran_DB[d][0] = quran_DB[a][0]);
    }
  d = (function (a, b) {
    ...
    buttons: [
      {
        ...
        text: "ކޮޕީ",
        messageTop: "البطاقات - 114 بطاقة تعريف بسور القران الكريم",
        title: "",
        customize(a) {
          a = a.replace(/\r\n|\n/g, "\t");
