$(document).ready(() => {
  ...
  const c = $("#hisnulMuslimTable").DataTable({
    data: hisnulMuslim_dataSet,
    columns: [
      { data: 0, title: "#" },
      {
        data: 1,
      ...
      { data: 2, title: "ދިވެހި ބާބު" },
      { data: 3, title: "Eng Chapter" },
      { data: 4, title: "އަރަބި ޒިކުރު" },
      {
        data: 4,
      ...
      { data: 5, title: "ޓްރާންސްލިޓަރޭޝަން" },
      { data: 6, title: "ދިވެހި ތަރުޖަމާ" },
      { data: 7, title: "English" },
      { data: 8, title: "ތަޚްރީޖު" },
      { data: 9, title: "ތަޚްރީޖު ދިވެހިން" },
    ],
    columnDefs: [
      {
        targets: "_all",
    ...
    language: {
      buttons: {
        copyTitle: "ކޮޕީ",
        copySuccess: { 1: "ކޮޕީ ވީ 1 ޒިކުރު", _: "ކޮޕީ ވީ %d ޒިކުރު" },
      },
    ...
    buttons: [
      {
        ...
        text: "ކޮޕީ",
        messageTop: "ޙަދީޘްއެމްވީ – މުސްލިމުންގެ ކިއްލާ",
        title: "",
        customize(a) {
          a = a.replace(/\r\n\r\n/g, " ");
          a = a.replace(/\n\n/g, " ");
          ...
          a = a.replace(/\n/g, "\t");
          a = a.replace(/#\t/g, "");
          a = a.replace(/އަރަބި ބާބު\t/g, "");
          a = a.replace(/ދިވެހި ބާބު\t/g, "");
          a = a.replace(/Eng Chapter\t/g, "");
          a = a.replace(/އަރަބި ޒިކުރު\t/g, "");
          a = a.replace(/ޒިކުރު ފިލިނުޖަހައި\t/g, "");
          a = a.replace(/ޓްރާންސްލިޓަރޭޝަން\t/g, "");
