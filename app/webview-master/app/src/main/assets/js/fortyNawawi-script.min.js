$(document).ready(() => {
  ...
  const c = $("#fortyNawawiTable").DataTable({
    ...
    columns: [
      ...
      { data: 1, title: "އަރަބި ނަމްބަރ" },
      { data: 2, title: "އަރަބި ސުރުހީ" },
      { data: 3, title: "ދިވެހި ސުރުހީ" },
      ...
      { data: 7, title: "ބާބު ތަރުޖަމާ" },
      { data: 8, title: "English" },
