...
function filiString(){var a=document.getElementById("toggleFiliButton");"&nbsp; އަރަބި ފިލިތައް ފޮރުވާ &nbsp;"===a.innerHTML.trim()?a.innerHTML="&nbsp; އަރަބި ފިލިތައް ދައްކާ &nbsp;":a.innerHTML="&nbsp; އަރަބި ފިލިތައް ފޮރުވާ &nbsp;"}function changeBookQuran(a){window.location=window.location.toString().replace(/quranUshru|quranHmv|quranBakurube|quranJaufar|quranSoabuni|quranRasmee|quranMuyassarGhareeb|quranMukhtasar|quranMuyassar|quranSadi|quranBetaqat|quranQiraaath/g,a).replace(/:v.*$/,"")}
function changeBookRadheef(a){window.location=window.location.toString().replace(/radheefAll|radheefRasmee|radheefEegaal|radheefManiku|nanfoiy/g,a).replace(/:v.*$/,"")};
