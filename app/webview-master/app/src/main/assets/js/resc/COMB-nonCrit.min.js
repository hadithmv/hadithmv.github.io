...
// hmv-script.js
function copyURLToClipB(){var a=document.createElement("textarea");document.body.appendChild(a);a.value=window.location;a.value=a.value.replace(/^.+hadithmv\./,"https://hadithmv.");a.select();document.execCommand("copy");document.body.removeChild(a)} 600<window.innerWidth&&(document.onkeyup=function(a){a.shiftKey&&76==a.which&&(a=document.createElement("textarea"),document.body.appendChild(a),a.value=window.location,a.value=a.value.replace(/^.+hadithmv\./,"https://hadithmv."),a.select(),document.execCommand("copy"),document.body.removeChild(a))});
