$(document).ready(() => {
  ...
  const c = $("#aqidahNawawiTable").DataTable({
    data: aqidahNawawi_DB,
    columns: [
      {
        data: 0,
        title: "ص #",
      ...
      { data: 1, title: "العنوان بالعربي" },
      { data: 2, title: "ނޯޓު" },
      { data: 3, title: "النص بالعربي" },
      {
        data: 3,
        title: "بدون تشكيل",
        render: function (a, b, d) {
    ...
    language: {
      buttons: {
        copyTitle: "نسخ",
        copySuccess: { 1: "تم نسخ 1 صفحة", _: "نسخ %d تم نسخ" },
      },
      ...
      searchPanes: {
        ...
        title: { _: "%d فلاتر البحث", 0: "0 فلاتر البحث", 1: "1 فلاتر البحث" },
      },
    },
    buttons: [
      {
        ...
        text: "نسخ",
        messageTop: "حديث أم وي – دراسة عقيدة النووي",
        title: "",
        customize(a) {
          a = a.replace(/\r\n|\n/g, "\t");
          a = a.replace(/ص #\t/g, "");
          a = a.replace(/العنوان بالعربي\t/g, "");
          a = a.replace(/ނޯޓު\t/g, "");
          a = a.replace(/النص بالعربي\t/g, "");
          a = a.replace(/بدون تشكيل\t/g, "");
          a = a.replace(/الحاشية بالعربي\t/g, "");
          a = a.replace(
            /\t‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾/g,
            "\n\n‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\n"
          );
