$(document).ready(() => {
  ...
  const c = $("#eegaalTable").DataTable({
    ...
    columnDefs: [
      ...
      { className: "eegCol1", targets: [0], visible: !0, searchable: !0 },
      { className: "eegCol2", targets: [1], visible: !1, searchable: !0 },
      { className: "eegCol3", targets: [2], visible: !0, searchable: !0 },
      { className: "eegCol4", targets: [3], visible: !1, searchable: !0 },
      { className: "eegCol5", targets: [4], visible: !0, searchable: !0 },
      {
        targets: "all",
        render(a, b, d, g) {
          return "export" === b
    ...
    buttons: [
      {
        ...
        text: "ކޮޕީ",
        messageTop: "އަލްއީޤާޡް އަރަބި ދިވެހި ރަދީފު",
        title: "",
        customize(a) {
          a = a.replace(/\r\n|\n/g, "\t");
          ...
          a = a.replace(/އަރަބި ފިލިނުޖަހައި 2\t/g, "");
          a = a.replace(/ސަފުހާ #\t/g, "");
          a = a.replace(/\t\t/g, "\t");
          return (a = a.replace(/\n\n\n\n|\n\n\n|\t|\s\s/g, "\n\n"));
        },
