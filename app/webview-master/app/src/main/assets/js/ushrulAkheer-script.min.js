$(document).ready(() => {
  ...
  const c = $("#quranUshruTable").DataTable({
    data: quranUshru_DB,
    columns: [
      {
        data: 0,
    ...
    buttons: [
      {
        ...
        text: "ކޮޕީ",
        messageTop: "ޙަދީޘްއެމްވީ – އަޙްމަދު ލިޔުއްވި ސުންނަތުގެ އުސޫލުތައް",
        title: "",
        customize(a) {
          a = a.replace(/\r\n\r\n|\n\n/g, " ");
          a = a.replace(/\r\n|\n/g, "\t");
          ...
          a = a.replace(/ފިލިނުޖަހާ ދ ތަރުޖަމާ\t/g, "");
          a = a.replace(
            /\t‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾/g,
            "\n\n‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\n"
          );
