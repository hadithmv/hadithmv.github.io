...
b,c){return a.replace(/[َ|ً|ُ|ٌ|ِ|ٍ|ْ|ّ|~|⁽|⁾|¹²³⁴⁵⁶⁷⁸⁹⁰]/g,"").replace(/(\n)/g,'<br class="br">')}},{data:4,title:"މަސްދަރު"},{data:5,title:"ލިންކު"}],columnDefs:[{targets:[7],data:"download_link",render:function(a,b,c,g){a=a.split(" ");url=a.shift();a=a.length?a.join(" "):url;return'<a href="'+url+'" rel="noopener noreferrer" target="_blank">'+a+"</a>"}},{targets:"_all",render:function(a,b,c){return a.replace(/\r\n|\n|\r/g,'\t<br class="br">')}},{className:"ColKitab",targets:[0],visible:!0,searchable:!0,
