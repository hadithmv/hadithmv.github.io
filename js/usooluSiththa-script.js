...
$(document).ready(() => {
  ...
  const table = $("#usooluSiththaTable").DataTable({
    // var table = $("#fortyNawawi").DataTable({
    // NOT DataTable();

    // CHANGE123 JSON
    data: usooluSiththa_DB, // https://datatables.net/manual/ajax
    ...
    buttons: [
      ...
      // { alert( "Button 2 clicked on" ); } },
      {
        ...
        customize(data) {
          ...
          data = data.replace(/شرح خالد المصلح\t/g, "");
