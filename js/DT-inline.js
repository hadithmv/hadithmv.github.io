...
const CURRENT_PAGE = fullPath.split("/").pop().replace(".html", "");

// Get the full path directory structure (everything between domain and filename)
// This removes the filename and keeps all directories
const pathStructure = fullPath.substring(0, fullPath.lastIndexOf("/"));

// Base domain
const baseDomain = "hadithmv.github.io";

// Construct the full canonical URL
const canonicalUrl = `https://${baseDomain}${pathStructure}/${CURRENT_PAGE}.html`;
