$(document).ready(() => {
  ...
  const c = $("#muwattaTable").DataTable({
    ...
    columns: [
      ...
      { data: 1, title: "ބިސްމި" },
      { data: 2, title: "ފޮތް އަރަބިން" },
      { data: 3, title: "ފޮތް ދިވެހިން" },
      { data: 4, title: "ބާބު އަރަބިން" },
      { data: 5, title: "ބާބު ދިވެހިން" },
      { data: 6, title: "އަރަބި ޙަދީޘް" },
      {
        data: 6,
