...
function sideMenutoggleNavbarDropdown(n, a) {
  a && a.stopPropagation(),
    (a = n.querySelector(
      ".navbar-dropdown-content, .sub-navbar-dropdown-content, .sub-sub-navbar-dropdown-content"
    ));
  var o = n.querySelector(".navbar-dropdown-arrow");
  a &&
  ...
  for (let l of a)
    l !== n &&
      ...
      (o = l.querySelector(".navbar-dropdown-arrow")),
...
document.addEventListener("DOMContentLoaded", createNavbar),
  document.addEventListener("click", function (n) {
    ...
    const l = o.contains(n.target),
      e = n.target.classList.contains("navbar-site-icon");
    (n.target.classList.contains("navbar-menu-icon") ||
      (a && !e) ||
