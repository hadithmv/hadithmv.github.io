...
$(document).ready(() => {
  ...
  const table = $('#allHadithTable').DataTable({
    ...
    columns: [
      ...
      { /* add brackets string to hukum */
        ...
        render: function (data, type, row) {
          ...
          data = data.replace('السنن الكبرى للبيهقي', 'ބައިހަގީގެ ސުނަން އަލްކުބްރާ')
    ...
    lengthMenu: [[1, 2, 3, 5], ['1 ދައްކާ', 2, 3, 5]],
...
<"#id.class" and > - div with an ID and a class */
    ...
    buttons: [
      ...
      // { alert( "Button 2 clicked on" ); } },
      {
        ...
        text: 'ކޮޕީ',
        messageTop: 'ޙަދީޘްއެމްވީ - އެއްކުރަމުންދާ ޙަދީޘްތައް', // CHANGE123 clipboard message
