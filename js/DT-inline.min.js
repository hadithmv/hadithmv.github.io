...
document.addEventListener("DOMContentLoaded", function () {
  const e = document.querySelector(".belowPage-bab-dropdown");
  if (e) {
    e.addEventListener("click", function (t) {
      if ((t.preventDefault(), "A" === (t = t.target).tagName)) {
        var a = t.parentElement;
        t.classList.contains("open-all")
          ? (function (e) {
              e.querySelectorAll("li").forEach((e) => {
                e.querySelector("ul") && e.classList.add("active");
              });
            })(e)
          : t.classList.contains("collapse-all")
          ? (function (e) {
              e.querySelectorAll("li > ul > li.active").forEach((e) => {
          ...
          : t.hasAttribute("data-value") &&
            ...
            (a = window.location.hash.match(/l(\d+)/)),
            (window.location.hash = `#tableID=l${a ? a[1] : "1"}:p${t}`),
            window.scrollTo({ top: 0, behavior: "smooth" }),
            setTimeout(() => {
              location.reload();
            }, 150));
          ...
          buttons: [
            {
              ...
              customize: function (e) {
                if (
                  ...
                  "undefined" != typeof currentSurah && currentSurah)
                ) {
                  e = e.split("\n");
                  var t = currentSurah,
...
(DataTable.defaults.layout = {
  ...
  Object.assign(DataTable.defaults, {
    ...
    stateSaveParams: function (e, t) {
      for (e = 0; e < t.columns.length; e++) delete t.columns[e].visible;
    },
    stateDuration: 86400,
    ordering: !1,
    orderClasses: !1,
  ...
  document.addEventListener("DOMContentLoaded", function () {
    isMobile
      ? (table.on("page", function () {
          var e = document.querySelector("tbody tr");
          const t = document.querySelector(".navbar").offsetHeight;
