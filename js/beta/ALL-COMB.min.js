...
function toggleQuranFili() {
  var e = $(".dataTable").DataTable().column(4).visible();
  $(".dataTable").DataTable().column(4).visible(!e),
    (e = $(".dataTable").DataTable().column(5).visible()),
...
function rasmString() {
  var e = document.getElementById("toggleUthmaniImlai");
  "&nbsp; ރަސްމު އުޘްމާނީ &nbsp;" === e.innerHTML.trim()
    ? (e.innerHTML = "&nbsp; ރަސްމު އިމްލާއީ &nbsp;")
    : (e.innerHTML = "&nbsp; ރަސްމު އުޘްމާނީ &nbsp;");
}
      ...
      <ul class=dropdown-content>
        ...
        <li onclick=toggleDropdown(this,event) class=sub-dropdown>
          ...
          <ul class=sub-dropdown-content>
            ...
            <li>
              <a onclick="changeBkRadheef('radheefAll')">1 އެއްކުރަމުންދާ ރަދީފުތައް</a>
            </li>
            <li>
              <a onclick="changeBkRadheef('radheefRasmee')">2 ރަސްމީ ރަދީފު</a>
            </li>
            <li>
              <a onclick="changeBkRadheef('radheefEegaal')">3 އަލްއީގާޡް</a>
            </li>
            <li>
              <a onclick="changeBkRadheef('radheefManiku')">4 މަނިކުގެ ރަދީފު</a>
            </li>
            <li>
              <a onclick="changeBkRadheef('radheefNanfoiy')">5 ނަންފޮތް</a>
            </li>
...
function toggleDropdown(a, o) {
  o && o.stopPropagation(),
    (o = a.querySelector(
      ".dropdown-content, .sub-dropdown-content, .sub-sub-dropdown-content"
    ));
  var e,
    n = a.querySelector(".dropdown-arrow");
  o &&
    (o.classList.toggle("show"),
    (n.style.transform = o.classList.contains("show") ? "rotate(-90deg)" : ""));
  for (e of (o = a.parentElement.children))
    e !== a &&
      ((o = e.querySelector(
        ".dropdown-content, .sub-dropdown-content, .sub-sub-dropdown-content"
      )),
      (n = e.querySelector(".dropdown-arrow")),
      o) &&
      (o.classList.remove("show"), (n.style.transform = ""));
}
document.addEventListener("DOMContentLoaded", createNavbar),
  document.addEventListener("click", function (a) {
    var o = document.querySelector(".navbar"),
      ...
      n = e.contains(a.target),
      l = a.target.classList.contains("site-icon");
    ...
    window.matchMedia("(max-width: 599px)").matches &&
      window.addEventListener(
        ...
        ((o, e) => {
          ...
          return function () {
            var a = arguments;
            n || (o.apply(this, a), (n = !0), setTimeout(() => (n = !1), e));
          };
        })(function () {
          var a;
          e &&
...
document.addEventListener("DOMContentLoaded", function () {
  let o = document.querySelector(".nested-dropdownButton");
  o &&
        ...
        "A" === (e = e.target).tagName &&
          ...
          e.classList.contains("open-all")
            ...
            : e.classList.contains("collapse-all")
              ? o.querySelectorAll("li > ul > li.active").forEach((e) => {
