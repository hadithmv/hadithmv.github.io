...
<div class="side-menu" id="sideMenu">
  ...
  <ul>
      ...
      <ul class="dropdown-content">
        <li onclick="sideMenutoggleDropdown(this,event)" class="sub-dropdown">
          ...
          <ul class="sub-dropdown-content">
            <li>
              <a href="../books/quranHadithmv.html">ޙަދީޘްއެމްވީގެ ތަރުޖަމާ</a>
            </li>
            <li>
              <a href="../books/quranRasmee.html">ރަސްމީ ތަރުޖަމާ</a>
            </li>
            <li>
              <a href="../books/quranBakurube.html">ބަކުރުބެގެ ތަރުޖަމާ</a>
            </li>
            <li>
              <a href="../books/quranJaufar.html">ޖަޢުފަރުގެ ގުރްއާން ތަފްސީރު*</a>
            </li>
            <li>
              <a href="../books/quranSoabuni.html"></a>
            </li>
            <li>
              <a href="../books/quranUshru.html">ފަހު ދިހަބައި ކުޅަ އެއްބައިގެ ތަފްސީރު</a>
            </li>
          </ul>
        </li>
        <li onclick="sideMenutoggleDropdown(this,event)" class="sub-dropdown">
          ...
          <ul class="sub-dropdown-content">
            <li>
              <a href="../books/allAthar.html">އެއްކުރަމުންދާ ޙަދީޘާއި އަޘަރު*</a>
            </li>
            <li>
            ...
            <li>
              <a href="../books/arbaoonAajurry.html">އާޖުއްރީގެ ސާޅީސް ޙަދީޘް*</a>
            </li>
            <li>
              <a href="../books/akhbaruShuyukh.html">ޝައިޚުންގެ ޚަބަރުތަކާއި އެބޭކަލުންގެ އަޚްލާގު</a>
            </li>
            <li>
              <a href="../books/akhlaqHamalathilQuran.html">އާޖުއްރީގެ ގުރްއާން އުފުލާ މީހުންގެ އަޚްލާގު</a>
            </li>
            <li>
            ...
            <li>
              <a href="https://archive.org/details/uloomul-hadith-dv-ahmed-faruq-mohamed" target="_blank">ޙަދީޘް މުސްޠަލަޙު ފަސޭހަކުރުން PDF</a>
            </li>
          </ul>
        </li>
        <li onclick="sideMenutoggleDropdown(this,event)" class="sub-dropdown">
          ...
          <ul class="sub-dropdown-content">
            <li>
              <a href="../books/allAqida.html">އެއްކުރަމުންދާ އަގީދާގެ ފޮތްތައް</a>
            </li>
            <li>
              <a href="../books/usooluSunnahAhmed.html">އަޙްމަދުގެ ސުންނަތުގެ އުސޫލުތައް*</a>
            </li>
            <li>
              <a href="../books/sharhuSunnahBarbahari.html">ބަރްބަހާރީގެ ސުންނަތުގެ ޝަރަހަ*</a>
            </li>
            <li>
              <a href="../books/aqidatuRaziyain.html">ދެ ރާޒީންގެ އަގީދާ*</a>
            </li>
            <li>
              <a href="../books/kitabulEmanAbiUbaid.html">އަބޫ ޢުބައިދުގެ އީމާންކަމުގެ ފޮތް</a>
            </li>
            <li>
              <a href="../books/nawaqidulislam.html">އިސްލާމްކަން ގެއްލޭ ކަންތައް</a>
            </li>
            <li>
            ...
            <li>
              <a href="../books/quranUshru.html#quranTable=:p69.html">މުސްލިމަކަށް މުހިއްމުވާ ހުކުމްތައް</a>
            </li>
            <li>
              <a href="../books/sharhuSunnahBarbahari-DFK.html">ބަރްބަހާރީގެ ސުންނަތުގެ ޝަރަހަ - DFK</a>
            </li>
          </ul>
        </li>
        <li onclick="sideMenutoggleDropdown(this,event)" class="sub-dropdown">
          ...
          <ul class="sub-dropdown-content">
            ...
            <li>
              <a href="../page/lafzuVakikohLiyumugeQawaid.html">ލަފުޒު ވަކިކޮށް ލިޔުމުގެ ގަވާއިދު (ދިވެހި)</a>
            </li>
          </ul>
        </li>
      </ul>
    ...
    <li>
      <a href="../notes/info/helpTranslate.html">ތަރުޖަމާގައި އެހީވެދިނުމަށް</a>
    </li>
    <li>
      <a href="../notes/info/FAQ.html">ތަކުރާރުކޮށް ކުރެވޭ ސުވާލުތައް</a>
    </li>
    <li>
    ...
    <li>
      <a href="https://t.me/ashraafmv">ފަރުމާ ކުރީ: އަބޫ ޔަޙްޔާ، މުޙައްމަދު އަޝްރާފު އިބްރާހީމް</a>
    </li>
    <li style="font-size:90%">މަދީނާގެ ޙަދީޘް ކުއްލިއްޔާގެ ދަރިވަރެއް</li>
    <li onclick='window.scrollTo({top:0,behavior:"smooth"})' href="#" style="cursor:pointer;user-select:none">▲ މައްޗަށް ސްކްރޯލްކުރޭ</li>
    <li onclick="sideMenutoggleDropdown(this)" class="dropdown">
      <a>↺ ސަފުހާ ރީލޯޑު</a>
      <ul class="dropdown-content">
        <li>
