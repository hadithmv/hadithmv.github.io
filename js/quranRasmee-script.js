...
$(document).ready(() => {
  ...
  const table = $("#quranTable").DataTable({
    ...
    columnDefs: [
      ...
      {
        className: "qCol7", // tharujama w arabic words
        targets: [6],
        visible: false,
        searchable: true,
        searchPanes: {
      ...
      {
        className: "qCol8", // tharujama only dhivehi
        targets: [7],
        visible: true,
        searchable: true,
        searchPanes: {
  ...
  <"#id.class" and > - div with an ID and a class */
    ...
    buttons: [
      ...
      // { alert( "Button 2 clicked on" ); } },
      {
        ...
        text: "ކޮޕީ",
        messageTop:
          "ކީރިތި ޤުރްއާނުގެ ދިވެހި ތަރުޖަމާ - ރައީސުލްޖުމްހޫރިއްޔާގެ އޮފީސް", // CHANGE123 clipboard message
