...
$(document).ready(() => {
  ...
  const table = $("#quranTable").DataTable({
    ...
    columns: [
      ...
      {
        data: 6,
        title: "ތަރުޖަމާ އަރަބިއާއެކު",
      },
      {
        data: 7,
        title: "ތަރުޖަމާ ތާނައެކަނި",
      },
    ],
    ...
    columnDefs: [
      ...
      {
        className: "qCol8", // tharujama w arabic words
        targets: [7],
        visible: false,
        searchable: true,
        searchPanes: {
      ...
      {
        className: "qCol9", // tharujama only dhivehi
        targets: [8],
        visible: true,
        searchable: true,
        searchPanes: {
  ...
  */
    ...
    buttons: [
      ...
      // { alert( "Button 2 clicked on" ); } },
      {
        ...
        text: "ކޮޕީ",
        messageTop: "ރަސްމީ ޤުރްއާން ތަރުޖަމާ", // CHANGE123 clipboard message
        ...
        customize(data) {
          ...
          data = data.replace(/ތަރުޖަމާ އަރަބިއާއެކު\t/g, "");
