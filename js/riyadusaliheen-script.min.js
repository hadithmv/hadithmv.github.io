$(document).ready(() => {
  ...
  const c = $("#riyadusaliheenTable").DataTable({
    data: riyadusaliheen_DB,
    columns: [
      {
        data: 0,
        title: "#",
    ...
    columnDefs: [
      ...
      { className: "ColKitab2", targets: [2], visible: !1, searchable: !1 },
      {
        className: "ColBaab",
        targets: [3],
        visible: !0,
    ...
    buttons: [
      {
        ...
        text: "ކޮޕީ",
        messageTop: "ޙަދީޘްއެމްވީ – ރިޔާޟުއްޞާލިހީން",
        title: "",
        customize(a) {
          a = a.replace(/\r\n\r\n|\n\n/g, " ");
          a = a.replace(/\r\n|\n/g, "\t");
