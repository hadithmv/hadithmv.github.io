const nawaqid_dataSet=[
    ...
    [
        ...
        "[މެދުވެރިން]",
        "الثَّانِي: مَنْ جَعَلَ بَيْنَهُ وَبَيْنَ اللَّهِ وَسَائِطَ، يَدْعُوهُمْ، وَيَسْأَلُهُمُ الشَّفَاعَةَ، وَيَتَوَكَّلُ عَلَيْهِمْ؛ كَفَرَ إِجْمَاعاً.",
        "ދެވަނަ ކަމަކީ: ﷲ އާ އެ މީހަކާ ދެމެދު މެދުވެރިއަކު ބަހައްޓައި، އެ މެދުވެރިވާ ފަރާތްތަކަށް ދުއާކޮށް، އެ ފަރާތްތަކަށް ޝަފާއަތަށް އެދި، އެ ފަރާތްތަކަށް ވަކީލު ކުރާ މީހާއެވެ. (އިލްމުވެރިންގެ) އިޖްމާއާއެކު (އެފަދަ މީހަކު) ކާފަރުވެއްޖެއެވެ.",
        "Second: Whoever places intermediaries between himself and Allah, calling unto them and asking intercession from them, and trusting in them, has committed disbelief according to the unanimous agreement (of scholars, ie: Ijmaa’).",
        "",
        ""
    ],
    [
        "3",
        "[من لم يكفر المشركين]",
        "[މުޝްރިކުން ކާފަރު ނުކުރުން]",
        "الثَّالِثُ: مَنْ لَمْ يُكَفِّرِ المُشْرِكِينَ، أَوْ شَكَّ فِي كُفْرِهِمْ، أَوْ صَحَّحَ مَذْهَبَهُمْ؛ كَفَرَ إِجْمَاعاً.",
        "ތިންވަނަ ކަމަކީ: މުޝްރިކުން ކާފަރު ނުކުރާ، ނުވަތަ އެބައިމީހުންގެ ކުފުރުކަމާމެދު ޝައްކުވާ، ނުވަތަ އެބައިމީހުން ދެކޭ ގޮތް ރަނގަޅު ކުރާ މީހާއެވެ. (އިލްމުވެރިންގެ) އިޖްމާއާއެކު (އެފަދަ މީހަކު) ކާފަރުވެއްޖެއެވެ.",
        "Third: Whoever does not hold the polytheists to be disbelievers, or has doubts about their disbelief or considers their ways to be correct, has committed disbelief according to the unanimous agreement (of scholars, ie: Ijmaa’).",
        "",
        ""
    ],
    [
        "4",
        "[من اعتقد أن غير هدي النبي ﷺ أكمل من هديه]",
        "[ނަބިއްޔާގެ ހުކުމަށްވުރެ އެހެން ހުކުމެއް ރަނގަޅުކަމަށް ދެކުން]",
        ...
        "ހަތަރުވަނަ ކަމަކީ: ނަބިއްޔާ ﷺ ގެ ހިދާޔަތަށް ވުރެ، އެހެން ހިދާޔަތެއް ފުރިހަމަ ކަމަށް ދެކޭ، ނުވަތަ ނަބިއްޔާގެ ހުކުމްފުޅަށް ވުރެ އެހެން ފަރާތެއްގެ ހުކުމް މާ ރަނގަޅު ކަމަށް ދެކޭ މީހާއެވެ. އެއީ ނަބިއްޔާގެ ހުކުމްފުޅަށް ވުރެ ޠާޣޫތުންގެ ހުކުމް ރަނގަޅު ކަމަށް ދެކޭ މީހުންނެވެ. ފަހެ (އެ ފަދަ މީހަކީ) ކާފަރެކެވެ.",
        "Fourth: Whoever believes that some guidance other than that of the Prophet ﷺ is more complete than his guidance, or that someone else’s judgement is better than his judgement, such as those who prefer the judgement of the Tawaagheet (false deities/religions) over his judgement, then he is a disbeliever.",
        "",
        ""
    ],
    [
        ...
        "[ރަސޫލާ ގެނެސްދެއްވި ކަމަކަށް ނަފްރަތުކުރުން]",
    ...
    [
        "6",
        "[من استهزأ بشيء من دين الله]",
        "[ދީނުގެ ކަމަކަށް މަލާމާތްކުރުން]",
    ...
    [
        ...
        "[ނަބިއްޔާއަށް ތަބާވާން ނުޖެހޭކަމަށް ގަބޫލުކުރުން]",
        "التَّاسِعُ: مَنِ اعْتَقَدَ أَنَّ بَعْضَ النَّاسِ لَا يَجِبُ عَلَيْهِ اتِّبَاعُ النَّبِيِّ ﷺ، وَأَنَّهُ يَسَعُهُ الخُرُوجُ عَنْ شَرِيعَتِهِ ﷺ - كَمَا وَسِعَ الخَضِرَ الخُرُوجُ عَنْ شَرِيعَةِ مُوسَى - عَلَيْهِ السَّلَامُ؛ فَهُوَ كَافِرٌ.",
        "ނުވަވަނަ ކަމަކީ: ނަބިއްޔާ ﷺ އަށް ތަބާވާން އެއްބަޔަކަށް ވާޖިބު ނުވާކަމަށް ގަބޫލު ކުރާ މީހާއެވެ. އަދި ހަމަކަށަވަރުން މޫސާ ޢަލައިހިއްސަލާމްގެ ޝަރީޢަތުން ޚަޟިރުގެފާނު ނުކުންނަން ހުއްދަވި ފަދައިން، ނަބިއްޔާ ﷺ ގެ ޝަރީޢަތުން އެ މީހަކު ނުކުންނަށް ހުއްދަވާކަމަށް ގަބޫލު ކުރާ މީހާއެވެ. ފަހެ އެ މީހަކީ ކާފަރެކެވެ.",
        "Ninth: Whoever believes that it is permitted for some people to be free of (implementing) the Shari’ah (revealed laws) of Muhammad, just as it was permitted for Al-Khidr to be free from the Shari’ah of Moosa, then he is a disbeliever.",
        "",
        ""
    ],
    [
