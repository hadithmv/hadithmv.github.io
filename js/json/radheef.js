let radheef_dataSet = [
  ...
  ["جِذْرُ الشَّمَنْدَر؛ جذور درنية للنبات","ރަންގުމޫ","Beetroot"  ],
  ...
  ["أَجدَل، حَرِج، خَطِر، دَقِيق، صَعب، عَسِير، عُقدَة، عَوِيص، مُبهَم، مُتَشَابِك، مَجدُول، مُجَمّع، مَجمُوعَة، مُخِيل، مُرَكَّب، مُستَغلِق، مُشكِل، مُعضِل، مُعَقَّد، مَفتُول، مُلتَبِس، مُلغَز، نَشَاطَاتٍ","އެކަުވެނި","Complex"  ],
  ["مُنَسِّق","ވިލީަރެސްކުރާމީހާ / ވިލަރެސްވެރިޔާ","Coordinator"  ],
  ...
  ["حد وقت الائتمان\n","އަރަނިި ގުނާ މުއްދަތު","Credit Time Limit"  ],
  ...
  ["بناء القدرة؛ تطوير القدرات\n","ޤާބިިލުކަން އިތުރުކުރުން / އެކަށޭނަކަން އިތުރުކުރުން","Capacity Development"  ],
  ["تغير المناخ أو التغير المناخي؛ تغيير مناخي؛ مسألة تغير المناخ\n","މޫސުމީ ބަދަލު","Climate Change"  ],
  ["التخطيط للطوارىء؛ تخطيط الطوارئ؛ تخطيط للطوارئ؛ خطة للطوارئ\n","ބަދިީލީ ރޭވުން","Contingency Planning"  ],
  ["القدرة على المواجهة؛ قدرة المواجهة\n","ބަރުދާސްތީ ޤާބިލުކަން","Coping Capacity"  ],
  ["إدارة مخاطر الكوارث التصحيحية","ކާރިިސީ ހިރާސް ކުޑަކުރުމުގެ ހަރަކާތް ބެލެހެއްޓުން / ކާރިސީ ރިސްކު ކުޑަކުރުމުގެ ހަރަކާތް ބެލެހެއްޓުން","Corrective Disaster Risk Management"  ],
  ...
  ["اختبار القبول\n","ވަނަުމަށްދޭ އިމްތިޙާނު","Admission Test"  ],
  ...
  ["مشروع التعليم والتدريب\n","މީހުުންބިނާކުރުމާއި، ތަޢުލީމު ކުރިއެރުވުމާ ބެހޭ މަޝްރޫޢު","Education And Training Project"  ],
  ...
  ["التنظيم الإداري؛ الهيكل التنظيمي؛ هيكل المنظمة","އިދިާރީއޮނިގަނޑު","Organization Structure"  ],
  ...
  ["سنة دراسية؛ عام دراسي","ދިރާާސީ އަހަރު","Academic Year"  ],
  ["تَثمِين، تَخمِين، تَقدِير، تَقوِيم، تَقيِيم، حَزر، ضريبة، مَحزَرَة","ވަޒީަންކުރުން / ދަސްވަރުބެލުން","Assessment"  ],
  ...
  ["اِختِيَارِيّ، اِنتخابي، انتقائيّ، إِرَادِيّ، تَخيِيرِيّ، خِيَارِيّ، طَوعِيّ، مُنتَخَب","ޚާިޔާރީ މާއްދާ","Elective"  ],
  ...
  ["ماجستير العلوم؛ ماجستير في العلوم","އެމްް.އެސް.ސީ ފާސް","MSc, Master of Science"  ],
  ...
  ["المخاطر المتوقعة\n","ތަަޙައްމަލު ކުރެވިދާނެ ހިރާސް / ތަޙައްމަލު ކުރެވިދާނެ ރިސްކު","Expectable Risk"  ],
  ...
  ["أَيِّم، مترمّل","ހުވަަފަތްވެފައި","Widowed"  ],
  ["أَبخِر، بُخَار، دُخَّان، دَخَن، ضباب، وَهم","އާވިި","Vapor"  ],
  ...
  ["رَذاذ، سَحَاب، سحب، سَدِيم، شابُورَة، شَبُّورَة، غَشَاوَة، غُطَيط، غَيم","ދުންފިނި","Mist"  ],
  ...
  ["اللغة الفرنسية\n","ފަރަންސޭސި ބަސް","French Language"  ],
