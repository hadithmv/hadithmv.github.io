...
!(function (a) {
    ...
    : "object" == typeof exports
      ? ((i = require("jquery")),
        ...
        "undefined" == typeof window
          ...
          : (n(window, i), (module.exports = a(i, window, window.document))))
  ...
  return (
    g.feature.register("inputPaging", function (t, e) {
      let a = new g.Api(t),
        i = (function (t) {
          ((t = t.table().container()), (t = t.classList));
          {
            if (
              t.contains("dt-bootstrap5") ||
              t.contains("dt-bootstrap4") ||
              t.contains("dt-bootstrap")
            )
              return {
      ...
      ((t = Object.assign({ firstLast: !0, previousNext: !0, pageOf: !0 }, e)),
        (e = c(i.wrapper)));
      let n = c(i.item, a.i18n("oPaginate.sFirst", "«"), (t) => {
          (t.preventDefault(),
            n.classList.contains(i.item.disabled) || a.page("first").draw(!1));
        }),
        s = c(i.item, a.i18n("oPaginate.sPrevious", "‹"), (t) => {
          (t.preventDefault(),
            s.classList.contains(i.item.disabled) ||
              a.page("previous").draw(!1));
        }),
        d = c(i.item, a.i18n("oPaginate.sNext", "›"), (t) => {
          (t.preventDefault(),
            d.classList.contains(i.item.disabled) || a.page("next").draw(!1));
        }),
        p = c(i.item, a.i18n("oPaginate.sLast", "»"), (t) => {
          (t.preventDefault(),
            p.classList.contains(i.item.disabled) || a.page("last").draw(!1));
        });
      var l = c(i.inputItem);
      let r = c(i.input),
        u = c({ tag: "span", className: "" });
      return (
        r.setAttribute("type", "text"),
        r.setAttribute("inputmode", "numeric"),
        r.setAttribute("pattern", "[0-9]*"),
        t.firstLast && e.appendChild(n),
        t.previousNext && e.appendChild(s),
        e.appendChild(l),
        t.previousNext && e.appendChild(d),
        t.firstLast && e.appendChild(p),
        l.appendChild(r),
        t.pageOf && l.appendChild(u),
        r.addEventListener("keypress", function (t) {
          (t.charCode < 48 || 57 < t.charCode) && t.preventDefault();
        }),
        r.addEventListener("input", function () {
          (r.value && a.page(r.value - 1).draw(!1),
            (r.style.width = r.value.length + 2 + "ch"));
        }),
        a.on("draw", () => {
          var t = a.page.info(),
            e =
              (o(n, i.item.disabled, 0 === t.page),
              o(s, i.item.disabled, 0 === t.page),
              0 === t.recordsTotal || 0 === t.recordsDisplay ? 0 : t.pages - 1);
          (o(d, i.item.disabled, t.page === e),
            o(p, i.item.disabled, t.page === e),
            0 === t.recordsTotal || 0 === t.recordsDisplay
              ? ((r.value = ""), (r.disabled = !0))
              : r.value !== t.page + 1 &&
                ((r.value = t.page + 1), (r.disabled = !1)),
            (u.textContent = " / " + t.pages));
        }),
        e
      );
    }),
...
((e) => {
  ...
  (x.extend(A.prototype, {
        ...
        if (h)
          if (((a = !(!h.config || !h.config.split)), Array.isArray(h)))
            ...
            var b = this._buildButton(
              ...
              o,
              void 0 !== h.split ||
                (void 0 !== h.config && void 0 !== h.config.split),
              i,
            );
            if (b) {
              if (
                ...
                ((b.collection = x("<" + u.container.tag + "/>")),
                  (b.conf._collection = b.collection));
                for (var g = 0; g < b.conf.split.length; g++) {
                  var m = b.conf.split[g];
                  "object" == typeof m &&
                    ((m.parent = r),
                    void 0 === m.collectionLayout &&
                      (m.collectionLayout = b.conf.collectionLayout),
              ...
              ((b.conf.parent = r),
                h.init && h.init.call(c.button(b.node), c, x(b.node), h),
                (l = b.node));
            }
          }
      }
        ...
        : ((s = function (t, n, e, o, i) {
          ...
          (l = h.liner.tag
            ? ((d = h.liner.tag.toLowerCase()),
              ...
              "a" === d && l.attr("href", "#"),
              ("a" !== d && "button" !== d) ||
                (l.attr("tabindex", this.s.dt.settings()[0].iTabIndex),
                (p = !0)),
              c.append(l),
              l)
            : (c.html(i(n.text)), c)),
        ...
        y =
          ...
          e &&
            ...
            (v = x(
              ...
              .on("keypress.dtb", function (t) {
                13 === t.keyCode &&
                  (t.preventDefault(), v.hasClass(h.disabled) || m(t, f, v, g));
              })),
    ...
    e.Api.register("button().add()", function (t, n, e) {
      ...
      return (o =
        i.length &&
        (i = A.instanceSelector(this._groupSelector, i[0]._buttons)).length
          ? i[0].add(n, t, e)
          : o)
  ...
  return (
    c.extend(o.prototype, {
                ...
                o.s.focusDraw ||
                  (o.s.lastFocus &&
                    ...
                    0 === n.recordsDisplay ||
                      i < n.start ||
                      i > n.start + n.length ||
                      (n.recordsDisplay <= i && (i = n.recordsDisplay - 1),
      ...
      _tabInput: function () {
        ...
        -1 != t &&
          (this.s.tabInput ||
            ((e = "keytable-focus-capture-" + this.s.namespace.split("-")[1]),
            (e = c(
              '<div><label for="' +
                e +
                '">' +
                ('<input id="' + e + '" type="text" tabindex="' + t + '"/>') +
                "</label></div>",
            ).css({
              position: "absolute",
              height: 1,
...
!(function (e) {
  ...
  function N(t, i, e, n, s, o, r) {
    ...
    var a = this,
      i =
        ((this.classes = B.extend(!0, {}, N.classes)),
        (this.c = B.extend(
          !0,
          {},
          N.defaults,
    ...
    if (
      ...
      (this.dom = {
        ...
        conditionTitle: B('<option value="" disabled selected hidden/>').html(
        ...
        data: B("<select/>")
          ...
          .addClass(this.classes.dropDown)
          .addClass(this.classes.italic),
        dataTitle: B('<option value="" disabled selected hidden/>').html(
  ...
  return (
    ...
    (N.parseNumFmt = function (t) {
      return +t.replace(/(?!^-)[^0-9.]/g, "");
    }),
    (N.prototype.updateArrows = function (t) {
      (void 0 === t && (t = !1),
      ...
      if (
        ...
        if (null !== this.s.type && t) {
          var n = m(),
            s = f();
          if (
            (this.s.type.includes("date") || this.s.type.includes("time"),
            ...
            for (i = 0; i < this.s.value.length; i++)
              this.s.value[i] &&
                ...
                n(this.s.value[i], this.s.dateFormat, !0).isValid() &&
                (this.s.value[i] = n(this.s.value[i], this.s.dateFormat).format(
                  "YYYY-MM-DD HH:mm:ss",
                ));
          else if (
            ...
            for (i = 0; i < this.s.value.length; i++)
              this.s.value[i] &&
                0 < this.s.value[i].length &&
                null ===
                  s.DateTime.fromFormat(this.s.value[i], this.s.dateFormat)
                    .invalid &&
      ...
      if (
        ...
        void 0 !== t.data &&
          ...
          this.dom.data.children("option").each(function () {
            !s &&
            (B(this).text() === t.data ||
              (t.origData && B(this).prop("origData") === t.origData))
    ...
    (N.prototype.setListeners = function () {
      var l = this;
    ...
    (N.prototype.setupButtons = function () {
      550 < u.innerWidth
    ...
    (N.prototype._buildCriteria = function () {
    ...
    (N.prototype._clearCondition = function () {
    ...
    (N.prototype._clearValue = function () {
      var t;
      if (void 0 !== this.s.condition) {
        ...
        if (
          ((this.dom.value = [].concat(
            this.s.conditions[this.s.condition].init(this, N.updateListener),
          )),
    ...
    (N.prototype._populateCondition = function () {
      var t = [],
      ...
      if (0 === i) {
        ((this.s.type = e.column(s).type()),
          ...
          (null !== this.s.type && void 0 !== this.s.type) ||
            (B.fn.dataTable.ext.oApi &&
              B.fn.dataTable.ext.oApi._fnColumnTypes(e.settings()[0]),
            (this.s.type = e.column(s).type())),
          this.dom.condition
            .removeAttr("disabled")
            .empty()
        ...
        var o,
          ...
          a =
            ("" !== r &&
              this.s.type &&
              this.s.type.indexOf(r) === this.s.type.length - r.length &&
        ...
        for (var d, l, u = 0, c = Object.keys(a); u < c.length; u++)
          null !== a[(l = c[u])] &&
            (e.page.info().serverSide &&
              a[l].init === N.initSelect &&
              ((d = n[s]),
              this.s.serverData && this.s.serverData[d.data]
                ? ((a[l].init = N.initSelectSSP),
                  (a[l].inputValue = N.inputValueSelect),
                  (a[l].isInputValid = N.isInputValidSelect))
                : ((a[l].init = N.initInput),
                  (a[l].inputValue = N.inputValueInput),
                  (a[l].isInputValid = N.isInputValidInput))),
      ...
      for (var g = 0, v = t; g < v.length; g++) this.dom.condition.append(v[g]);
          ...
          for (var y = 0; y < t.length; y++)
            for (
              ...
              var I,
                w = V[C];
              if (
                ("string" == typeof (I = this.s.conditions[w].conditionName)
                  ? I
                ...
                (this.dom.condition
                  .prop(
                    "selectedIndex",
                    this.dom.condition.children().toArray().indexOf(t[y][0]),
                  )
    ...
    (N.prototype._populateData = function () {
    ...
    (N.prototype._populateValue = function (i) {
      for (
        var t,
          e = this,
          n = this.s.filled,
    ...
    (N.prototype._throttle = function (n, s) {
      var o = null,
        r = null,
        a = this;
      return (
      ...
      for (
        var s = e.dom.data.children("option:selected").val(),
          ...
          a =
            ...
            B("<select/>")
              .addClass(N.classes.value)
              .addClass(N.classes.dropDown)
              .addClass(N.classes.italic)
              .addClass(N.classes.select)
              .append(e.dom.valueTitle)
              .on("change.dtsb", function () {
                (B(this).removeClass(N.classes.italic), t(e, this));
              })),
          d = (e.c.greyscale && a.addClass(N.classes.greyscale), []),
          l = [],
          u = 0,
          c = o;
        u < c.length;
          ...
          f =
            ...
            function (t, i) {
              ...
              -1 === d.indexOf(i) &&
                ...
                t.val() === n[0] &&
                (t.prop("selected", !0),
                a.removeClass(N.classes.italic),
    ...
    (N.initSelectSSP = function (t, i, e) {
      ...
      for (
        var n = B("<select/>")
            ...
            .on("change.dtsb", function () {
              (B(this).removeClass(N.classes.italic), i(t, this));
            }),
          s = (t.c.greyscale && n.addClass(N.classes.greyscale), []),
          o = 0,
        ...
        (t.s.type.includes("html") &&
          ...
          null !== e &&
            d.val() === e[0] &&
            (d.prop("selected", !0),
            n.removeClass(N.classes.italic),
            t.dom.valueTitle.removeProp("selected")));
      }
      for (var l = 0, u = s; l < u.length; l++) n.append(u[l]);
      return n;
    }),
    (N.initSelectArray = function (t, i, e) {
      return N.initSelect(t, i, (e = void 0 === e ? null : e), !0);
    }),
    (N.initInput = function (i, e, t) {
      void 0 === t && (t = null);
      var n = i.s.dt.settings()[0].searchDelay,
        n = B("<input/>")
          .addClass(N.classes.value)
          .addClass(N.classes.input)
          .on(
      ...
      return (
        i.c.greyscale && n.addClass(N.classes.greyscale),
        null !== t && n.val(t[0]),
    ...
    (N.init2Input = function (i, e, t) {
      ...
      return (
        i.c.greyscale &&
          (n[0].addClass(N.classes.greyscale),
          n[2].addClass(N.classes.greyscale)),
    ...
    (N.initDate = function (e, n, t) {
      void 0 === t && (t = null);
      var s = e.s.dt.settings()[0].searchDelay,
        i = e.s.dt.i18n("datetime", {}, !1),
        i = B("<input/>")
          .addClass(N.classes.value)
          .addClass(N.classes.input)
          .dtDateTime({ format: e.s.dateFormat || void 0, i18n: i })
          .on(
            "change.dtsb",
            e._throttle(
              function () {
      ...
      return (
        e.c.greyscale && i.addClass(N.classes.greyscale),
        null !== t && i.val(t[0]),
    ...
    (N.init2Date = function (e, n, t) {
      var i = this,
        s = (void 0 === t && (t = null), e.s.dt.settings()[0].searchDelay),
        o = e.s.dt.i18n("datetime", {}, !1),
        o = [
          B("<input/>")
            .addClass(N.classes.value)
            .addClass(N.classes.input)
            .dtDateTime({ format: e.s.dateFormat || void 0, i18n: o })
            .on(
              "change.dtsb",
              null !== s
      ...
      return (
        e.c.greyscale &&
          (o[0].addClass(N.classes.greyscale),
          o[2].addClass(N.classes.greyscale)),
    ...
    (N.isInputValidInput = function (t) {
      for (var i = !0, e = 0, n = t; e < n.length; e++) {
        var s = n[e];
    ...
    (N.inputValueSelect = function (t) {
      for (var i = [], e = 0, n = t; e < n.length; e++) {
        var s = n[e];
        s.is("select") &&
          ((s = []
            .concat(s.children("option:selected").data("sbv"))
            .map(function (t) {
              return N._escapeHTML(t);
            })),
          i.push.apply(i, s));
      }
      return i;
    }),
    (N.inputValueInput = function (t) {
      for (var i = [], e = 0, n = t; e < n.length; e++) {
        var s = n[e];
        s.is("input") && i.push(N._escapeHTML(s.val()));
      }
      return i.map(c.util.diacritics);
    }),
    (N.updateListener = function (t, i, e) {
    ...
    (N.dateConditions = {
      "=": {
        ...
        init: N.initDate,
        inputValue: N.inputValueInput,
        isInputValid: N.isInputValidInput,
        search: function (t, i) {
    ...
    (N.numConditions = {
      "=": {
        ...
        init: N.initSelect,
        inputValue: N.inputValueSelect,
        isInputValid: N.isInputValidSelect,
        search: function (t, i) {
          return +t == +i[0];
        },
      },
    ...
    i("searchBuilder.rebuild()", function (t, i) {
      ...
      return void 0 === e._searchBuilder
        ? null
        : (e._searchBuilder.rebuild(t, (i = void 0 === i ? !0 : i)), this);
    }),
...
!(function (e) {
      ...
      return (
        ...
        (this.dom = {
          ...
          collapseButton: _(
            ...
            .attr(
              "aria-label",
              t.i18n("searchPanes.buttons.collapse", this.c.i18n.aria.collapse),
            ),
          container: _("<div/>")
          ...
          countButton: _('<button type="button"><span></span></button>')
            ...
            .attr(
              "aria-label",
              t.i18n(
                "searchPanes.buttons.orderByCount",
                this.c.i18n.aria.orderByCount,
              ),
            ),
          dtP: _(
          ...
          nameButton: _('<button type="button"><span></span></button>')
            ...
            .attr(
              "aria-label",
              t.i18n(
                "searchPanes.buttons.orderByLabel",
                this.c.i18n.aria.orderByLabel,
              ),
            ),
          panesContainer: _(a),
          searchBox: _("<input/>")
          ...
          searchButton: _('<button type="button"><span></span></button>')
            ...
            .attr(
              "aria-label",
              t.i18n(
                "searchPanes.buttons.clearSearch",
                this.c.i18n.aria.clearSearch,
              ),
            ),
  ...
  function N(s, e, t) {
    var a = o.extend(
      ...
      a = new (
        a && (a.cascadePanes || a.viewTotal) ? D.SearchPanesST : D.SearchPanes
      )(s, a);
    (s
      .button(e)
  ...
  function F(t, s, e) {
    ...
    ((t = new B.Api(t)),
      (s = s || t.init().searchPanes || B.defaults.searchPanes));
  ...
  return (
    ...
    (T.prototype.setListeners = function () {
      ...
      this.s.dtPane &&
        ...
        this.dom.countButton.off("click.dtsp").on("click.dtsp", function () {
          var t = "asc" === h.s.dtPane.order()[0][1] ? "desc" : "asc";
          (h.s.dtPane
            .order([
              [2, t],
              [1, t],
    ...
    (T.prototype._populatePaneArray = function (t, s, a, e) {
    ...
    (T.prototype._buildPane = function (t, s, e) {
      ...
      var d,
        ...
        e =
          ...
          (r = _.fn.dataTable.versionCheck("2")
            ? ((d = _.extend(!0, {}, _.fn.dataTable.defaults.layout)),
              _.each(d, function (t, s) {
                d[t] = null;
              }),
              { layout: d })
            : { dom: "t" }),
        ...
        r =
          (this.s.customPaneSettings && this.s.customPaneSettings.header
            ...
            : this.s.colOpts.header
              ...
              : this.s.colExists &&
                (e = _.fn.dataTable.versionCheck("2")
          ...
          this.s.dt
            ...
            .replace("{name}", e));
      if (
        (this.dom.searchBox.attr("placeholder", e).attr("title", r),
      ...
      if (
        ...
        for (var y = 0, b = a.searchPanes.panes; y < b.length; y++) {
          ...
          C.id === this.s.index &&
            (C.searchTerm &&
              0 < C.searchTerm.length &&
              this.dom.searchBox.val(C.searchTerm).trigger("input"),
            C.order && this.s.dtPane.order(C.order).draw(),
            C.collapsed ? this.collapse() : this.show());
        }
      }
      return !0;
    }),
    ...
    (k.prototype._attach = function () {
      ...
      (this.dom.container[0].childNodes.forEach(function (t) {
        return t.remove();
      }),
        this.dom.container
          .removeClass(this.classes.hide)
          ...
          this.s.dt.page.info().serverSide
            ? i.off("preXhr.dtsps").on("preXhr.dtsps", function (t, s, e) {
                if (s === c) {
                  ...
                  (0 < a &&
                    (a !== h.s.filterCount &&
                      ((e.start = 0), (h.s.page = 0), h.s.dt.page(h.s.page)),
                    (h.s.filterCount = a)),
                    0 < h.s.selectionList.length &&
                      (e.searchPanesLast = h.s.dt
                        .column(
                          h.s.selectionList[h.s.selectionList.length - 1]
                            .column,
                        )
                        .dataSrc()),
                    (e.searchPanes_options = {
        ...
        for (var r = 0, l = this.s.selectionList; r < l.length; r++) {
          ...
          if (h.s.dtPane) {
            ...
            if (((h.s.selections = d.rows), 0 !== d.rows.length)) {
              this.s.dt.draw();
              for (
                var b = 0, C = 0, _ = 0, S = 0, O = this.s.panes;
                S < O.length;
                S++
              )
                (t = O[S]).s.dtPane &&
                  C < (b += t.getPaneCount()) &&
                  (_++, (C = b));
              for (var x = 0 < b, A = 0, B = this.s.panes; A < B.length; A++)
                (t = B[A]).s.displayed &&
                  (i || h.s.index !== t.s.index || !x
                    ? (t.s.filteringActive = x || i)
                    : 1 === _ && (t.s.filteringActive = !1),
                  t.s.index !== h.s.index) &&
                  t.updateRows();
            }
          }
    ...
    (l = (_ = o).fn.dataTable),
    (C = (b = o).fn.dataTable),
    ((B = (w = f = c = o).fn.dataTable).SearchPanes = O),
    (D.SearchPanes = O),
    (B.SearchPanesST = A),
    (D.SearchPanesST = A),
    (B.SearchPane = h),
    (D.SearchPane = h),
    (B.SearchPaneViewTotal = g),
    (D.SearchPaneViewTotal = g),
    (B.SearchPaneCascade = P),
    ...
    (D.ext.buttons.searchPanesClear = {
      action: function (t, s) {
        s.searchPanes.clearSelections();
      },
      text: "Clear Panes",
    }),
    (D.ext.buttons.searchPanes = {
    ...
    o(n).on("preInit.dt.dtsp", function (t, s) {
      "dt" !== t.namespace ||
        (!s.oInit.searchPanes && !D.defaults.searchPanes) ||
        s._searchPanes ||
        F(s, null, !0);
    }),
    D.ext.feature.push({ cFeature: "P", fnInit: F }),
    D.feature && D.feature.register("searchPanes", F),
    D
  );
});
...
((s) => {
    ...
    (t
      ...
      .on("click.dtSelect", l, function (e) {
        ...
        if (a) {
          ...
          if (
            (!l.anchorNode ||
              v(l.anchorNode).closest("table")[0] === o.table().node()) &&
            l !== a
          )
            return;
        }
  ...
  function l(l, e) {
    if ("api" !== l.select.style() && !1 !== l.select.info()) {
      var t = l.settings()[0],
        s = t._select_set;
      if (!l.page.info().serverSide)
        for (var c = s.length - 1; 0 <= c; c--) t.aIds[s[c]] || s.splice(c, 1);
      var n = s.length || l.rows({ selected: !0 }).count(),
        o = l.columns({ selected: !0 }).count(),
        a = l.cells({ selected: !0 }).count(),
        i =
          ("subtractive" === t._select_mode &&
            (n = l.page.info().recordsDisplay - s.length),
          function (e, t, s) {
            e.append(
    ...
    ((o._select_init = !0),
      ...
      o.aoRowCreatedCallback.push(function (e, t, s) {
        ...
        for (
          ...
          (o.aoColumns[l]._select_selected ||
            (n._selected_cells && n._selected_cells[l])) &&
            v(n.anCells[l]).addClass(o._select.className);
      }),
      (c = a).on("select", function (e, t, s, l) {
        "row" === s &&
          ("additive" === (s = c.settings()[0])._select_mode ? y : x)(
            c,
            s._select_set,
            l,
          );
      ...
      c.on("deselect", function (e, t, s, l) {
        "row" === s &&
          ("additive" === (s = c.settings()[0])._select_mode ? x : y)(
            c,
            s._select_set,
            l,
          );
      ...
      a.on("destroy.dtSelect", function () {
        (v(a.rows({ selected: !0 }).nodes()).removeClass(
  ...
  ((w.select = {}),
    ...
    (w.select.init = function (a) {
      ...
      !m._select &&
        ...
        (t = function (e, t, s) {
          if (null !== s && void 0 !== s.select) {
            if (
              ...
              void 0 !== s.select.columns &&
                a.columns(s.select.columns).select(),
              a.cells({ selected: !0 }).any() && a.cells().deselect(),
              void 0 !== s.select.cells)
            )
              for (var l = 0; l < s.select.cells.length; l++)
                a.cell(
                  s.select.cells[l].row,
                  s.select.cells[l].column,
                ).select();
            a.state.save();
          }
        }),
        ...
        !h &&
          v(a.table().node()).hasClass("selectable") &&
          a.select.style("os"),
                ...
                v("input", t).length ||
                  ((l = v("<input>")
                    .attr({
                      ...
                      type: "checkbox",
                      "aria-label":
                        c.i18n("select.aria.headerCheckbox") ||
                        "Select all rows",
                    })
                    .appendTo(t)
                    .on("change", function () {
      ...
      function (e, i) {
        w.ext.selector[i.type].push(function (e, t, s) {
          ...
          for (var o = 0, a = s.length; o < a; o++)
            (l = e[i.prop][s[o]]) &&
              ((!0 === c && !0 === l._select_selected) ||
                (!1 === c && !l._select_selected)) &&
              n.push(s[o]);
          return n;
        });
      },
    ...
    w.ext.selector.cell.push(function (e, t, s) {
      ...
      for (var o = 0, a = s.length; o < a; o++)
        (l = e.aoData[s[o].row]) &&
          ((!0 === c &&
            l._selected_cells &&
            !0 === l._selected_cells[s[o].column]) ||
            (!1 === c &&
              (!l._selected_cells || !l._selected_cells[s[o].column]))) &&
          n.push(s[o]);
      return n;
    }));
      ...
      return !1 === e
        ...
        : (this.iterator("row", function (e, t) {
            ...
            if (
              ...
              !1 === e._select.selectable(s._aData, s.nTr, t)
            )
              return;
            (v(s.nTr).addClass(e._select.className),
              (s._select_selected = !0),
              a.push(t));
            for (var c = 0; c < l.length; c++) {
              ...
              (null === n.sType && o.columns().types(),
                b(n) &&
                  ((n = s.anCells) &&
                    n[c] &&
                    v("input." + g(!0), n[c]).prop("checked", !0),
                  null !== s._aSortData) &&
                  (s._aSortData[c] = null));
            }
          }),
    ...
    t("rows().deselect()", "row().deselect()", function () {
      ...
      return (
        this.iterator("row", function (e, t) {
          var s = e.aoData[t],
            l = e.aoColumns;
          (v(s.nTr).removeClass(e._select.className),
            (s._select_selected = !1),
          ...
          for (var c = 0; c < l.length; c++) {
            ...
            (null === n.sType && o.columns().types(),
              b(n) &&
                ((n = s.anCells) &&
                  n[c] &&
                  v("input." + g(!0), s.anCells[c]).prop("checked", !1),
                null !== s._aSortData) &&
                (s._aSortData[c] = null));
          }
        }),
  ...
  return (
    v.extend(w.ext.buttons, {
      ...
      selectAll: {
        ...
        action: function (e, t, s, l) {
          ...
          (n
            ? ("function" == typeof n && (n = n.call(t, e, t, s, l)),
              this[c + "s"](n))
            : this[c + "s"]()
          ).select();
        },
    ...
    v.extend(!0, w.defaults.oLanguage, {
        ...
        .map(function (e) {
          return "row" === t._select.items
            ...
            : "cell" === t._select.items &&
                v(e).hasClass(t._select.className).toString();
        });
    }),
...
((s, X, u) => {
  ...
  function $(t, e) {
    ((this.options = M({}, O.defaults, e || {})),
      ...
      (this.element = t),
      (this.input = new (
        (e = this).options.inputClass || (at ? T : ht ? y : rt ? E : g)
      )(e, k)),
