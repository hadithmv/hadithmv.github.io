...
// hmv-script.js
function copyURLToClipButton2(){var a=document.createElement("textarea");document.body.appendChild(a);a.value=window.location.href;a.value=a.value.replace(/^.*\/books\//,"https://hadithmv.github.io/books/").replace(/^.*\/uc\//,"https://hadithmv.github.io/books/");a.select();document.execCommand("copy");document.body.removeChild(a)}
