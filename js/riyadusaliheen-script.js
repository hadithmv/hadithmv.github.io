...
$(document).ready(() => {
  ...
  const table = $("#riyadusaliheenTable").DataTable({
    // var table = $("#allHadith").DataTable({
    // NOT DataTable();

    // CHANGE123 JSON
    data: riyadusaliheen_DB, // https://datatables.net/manual/ajax
    ...
    columnDefs: [
      ...
      {
        className: "riyadCol7", // Ar Text Plain
        targets: [6],
        visible: false,
        searchable: true,
        searchPanes: {
...
<"#id.class" and > - div with an ID and a class */
    ...
    buttons: [
      ...
      // { alert( "Button 2 clicked on" ); } },
      {
        ...
        text: "ކޮޕީ",
        messageTop: "ޙަދީޘްއެމްވީ – ރިޔާޟުއްޞާލިހީން", // CHANGE123 clipboard message
