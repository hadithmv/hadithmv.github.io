...
function sideMenutoggleDropdown(a, o) {
  o && o.stopPropagation(),
    (o = a.querySelector(
      ".dropdown-content, .sub-dropdown-content, .sub-sub-dropdown-content"
    ));
  var l,
    e = a.querySelector(".dropdown-arrow");
  o &&
    (o.classList.toggle("show"),
    (e.style.transform = o.classList.contains("show") ? "rotate(-90deg)" : ""));
  for (l of (o = a.parentElement.children))
    l !== a &&
      ((o = l.querySelector(
        ".dropdown-content, .sub-dropdown-content, .sub-sub-dropdown-content"
      )),
      (e = l.querySelector(".dropdown-arrow")),
      o) &&
      (o.classList.remove("show"), (e.style.transform = ""));
}
document.addEventListener("DOMContentLoaded", createNavbar),
  document.addEventListener("click", function (a) {
    var o = document.querySelector(".navbar"),
      l = document.getElementById("sideMenu"),
      o = o.contains(a.target),
      e = l.contains(a.target),
      n = a.target.classList.contains("site-icon");
    (a.target.classList.contains("menu-icon") ||
      (o && !n) ||
              ...
              (function () {
                ...
                e &&
                  ...
                  (a = window.pageYOffset || document.documentElement.scrollTop)
                    ? (e.classList.remove("navbar-hidden"), (n = 0))
                    : a > l
                      ? (e.classList.add("navbar-hidden"), (n = 0))
                      : 200 < (n += l - a) &&
                        (e.classList.remove("navbar-hidden"), (n = 0)),
                  (l = 0 >= a ? 0 : a));
              }.apply(this, a),
...
function copyURLToClipButton() {
  var e = document.createElement("textarea"),
    t =
      ...
      document.getElementById("copyPageLink")),
    n = t.innerHTML;
...
function toggleQuranFili() {
  var e = $(".dataTable").DataTable().column(5).visible();
  $(".dataTable").DataTable().column(5).visible(!e),
    (e = $(".dataTable").DataTable().column(6).visible()),
    $(".dataTable").DataTable().column(6).visible(!e);
}
function toggleSurahName() {
  var e = $(".dataTable").DataTable().column(2).visible();
  $(".dataTable").DataTable().column(2).visible(!e),
    "&nbsp; ސޫރަތުގެ ނަތް ފޮރުވާ &nbsp;" ===
    (e = document.getElementById("toggleSurahButton")).innerHTML.trim()
      ? (e.innerHTML = "&nbsp; ސޫރަތުގެ ނަތް ދައްކާ &nbsp;")
      : (e.innerHTML = "&nbsp; ސޫރަތުގެ ނަތް ފޮރުވާ &nbsp;");
}
function uthmaniImlai() {
  var e = $(".dataTable").DataTable().column(5).visible();
  $(".dataTable").DataTable().column(5).visible(!e),
    (e = $(".dataTable").DataTable().column(7).visible()),
    $(".dataTable").DataTable().column(7).visible(!e),
    "&nbsp; ރަސްމު އުޘްމާނީއަށް &nbsp;" ===
    (e = document.getElementById("toggleUthmaniImlai")).innerHTML.trim()
      ? (e.innerHTML = "&nbsp; ރަސްމު އިމްލާއީއަށް &nbsp;")
      : (e.innerHTML = "&nbsp; ރަސްމު އުޘްމާނީއަށް &nbsp;");
}
let fontVar = new FontFace("mergedFont", "url(../font/hafs-400.woff)");
...
function filiString() {
  var e = document.getElementById("toggleFiliButton");
  "&nbsp; ފިލިތައް ފޮރުވާ &nbsp;" === e.innerHTML.trim()
    ? (e.innerHTML = "&nbsp; ފިލިތައް ދައްކާ &nbsp;")
    : (e.innerHTML = "&nbsp; ފިލިތައް ފޮރުވާ &nbsp;");
}
function changeBook(e) {
  ...
  t.includes(a) || t.includes("quranUshru")
    ? t.includes("quranUshru") && "quranUshru" !== e
      ? ((e = t.replace("quranUshru", e).split("#")[0]),
        (window.location = e.endsWith(".html") ? e : e + ".html"))
      : (window.location = t.replace(n, e).replace(/:v.*$/, ""))
    : (window.location =
          ...
          buttons: [
            {
              ...
              customize: function (n) {
                (n = (n = (n = n.replace(/\r\n|\n|\r/g, "\n")).replace(
                  ...
                  Object.entries(sansSerifDigits).forEach(([e, t]) => {
            ...
            },
            {
              ...
              buttons: [
                ...
                { extend: "searchBuilder", titleAttr: "custom search" },
                {
                  extend: "searchPanes",
                  config: {
                    cascadePanes: !0,
            ...
            { extend: "pageLength", background: !1 },
          ],
        },
      ],
...
(DataTable.defaults.layout = {
  ...
  Object.assign(DataTable.defaults, {
    language: {
      ...
      entries: { _: "", 1: "" },
      buttons: {
        pageLength: { _: "%d ދައްކާ", "-1": "ހުރިހާ" },
        copyTitle: "&nbsp; ކޮޕީ 📋",
      ...
      searchBuilder: {
        ...
        logicAnd: "އަދި &",
        logicOr: "ނޫނީ |",
        title: { 0: "ސާޗު ޝަރުތުތައް", _: "ސާޗު ޝަރުތުތައް (%d)" },
        value: "ލިޔުން",
        valueJoiner: "އަދި",
      },
      searchPanes: {
    ...
    buttons: [
      ...
      },
      {
        ...
        text: "☰ ބަރިތައް",
        background: !1,
        key: { shiftKey: !0, key: "s" },
      },
      {
        extend: "searchBuilder",
        titleAttr: "custom search",
        key: { shiftKey: !0, key: "b" },
      },
      {
        extend: "searchPanes",
        titleAttr: "filter",
        key: { shiftKey: !0, key: "p" },
        config: {
          cascadePanes: !0,
          viewTotal: !0,
          collapse: !1,
    ...
    isMobile
      ...
      $("tbody").on("dblclick", "tr", function () {
        "" !== table.search() && table.search("").draw(),
          table.row(this).draw().show().select().draw(!1);
      }),
...
document.addEventListener("DOMContentLoaded", function () {
  let l = document.querySelector(".belowPage-bab-dropdown");
  l &&
        ...
        "A" === (e = e.target).tagName &&
          ...
          e.classList.contains("open-all")
            ? l.querySelectorAll("li").forEach((e) => {
                e.querySelector("ul") && e.classList.add("active");
              })
            : e.classList.contains("collapse-all")
              ? l.querySelectorAll("li > ul > li.active").forEach((e) => {
...
// quran-dropdowns.js
function replaceDigitsWithArabic(r) {
  return r.replace(/[0-9]/g, function (r) {
    return arabicDigits[r];
  });
}
let arabicDigits = {
    0: "٠",
...
function QtoggleDropdown(r) {
  var a = $("#" + r + "Dropdown");
  $(".q-dropdown").not(a).hide(),
    a.toggle(),
    a.is(":visible") &&
      ((r = parseInt($("#" + r + "Value").text())),
      (r = a.find('.q-dropdown-item[data-value="' + r + '"]')).length &&
        r.get(0).scrollIntoView({ block: "center" }),
      a.find(".q-dropdown-search").val("").focus(),
      a.find(".q-dropdown-item").show(),
      a.find(".q-dropdown-item").removeClass("highlighted"));
}
function updateQValue(r, a) {
  (a = parseInt(a)),
    "surah" === r && surahNames[a]
      ? $("#" + r + "Value").text(a + " " + surahNames[a])
      : $("#" + r + "Value").text(a),
    "surah" === r
      ? ((currentSurah = a),
        (currentAyah = 1),
...
function QnavigateArrow(r, a) {
  var e, t;
  "surah" === r
    ? ((e = currentSurah), (t = maxSurah), (currentJuz = null))
    : "ayah" === r
      ? ((e = currentAyah),
        (t = ayahCounts[currentSurah] || 1),
        (currentJuz = null))
      : "juz" === r && ((e = parseInt($("#juzValue").text())), (t = maxJuz)),
    "prev" === a
      ? --e < 1 &&
        (e =
          "ayah" === r
            ? (--currentSurah < 1 && (currentSurah = maxSurah),
              updateAyahDropdown(),
              ayahCounts[currentSurah] || 1)
            : t)
      : t < ++e &&
        ("ayah" === r &&
          (++currentSurah > maxSurah && (currentSurah = 1),
          updateAyahDropdown()),
        (e = 1)),
    updateQValue(r, e);
}
  ...
  var r =
    null !== currentJuz
      ? table
          ...
          .indexes()
          .filter(function (r, a) {
            return (r = table.row(r).data()), parseInt(r[0]) == currentJuz;
          })
      : table
          .rows()
          .indexes()
          .filter(function (r, a) {
            return (
              (r = table.row(r).data()),
              parseInt(r[1]) == currentSurah && parseInt(r[2]) == currentAyah
            );
          });
  0 < r.length &&
    (table.row(r[0]).show().draw(!1), updateAllQValues(table.row(r[0]).data())),
    (currentJuz = null);
}
function updateAllQValues(r) {
  (currentJuz = parseInt(r[0])),
    (currentSurah = parseInt(r[1])),
    (currentAyah = parseInt(r[2])),
