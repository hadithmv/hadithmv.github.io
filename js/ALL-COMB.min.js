...
function getCanonicalUrl() {
  ...
  return "" === o || "/" === o
    ...
    : -1 !== (a = o.split("/").pop()).indexOf(".")
    ? ((a = a.replace(".html", "")),
      (o = o.substring(0, o.lastIndexOf("/"))),
      window.location.origin + o + "/" + a + ".html")
          ...
          buttons: [
            {
              ...
              customize: function (e) {
                ...
                return (e = e.map(function (e) {
                  return a.includes(e.trim()) ? t + " " + n : e;
                })).join("\n");
              },
            },
            {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    isMobile
      ...
      $("tbody").on("dblclick", "tr", function () {
        ...
        var e,
          t = table.row(this).index();
        void 0 !== t &&
          ((e = table.page.info()),
          table.page(Math.floor(t / e.length)).draw(!1),
          (t = table.row(t).node())) &&
