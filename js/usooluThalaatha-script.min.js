$(document).ready(() => {
  ...
  const c = $("#usooluThalaathaTable").DataTable({
    data: usooluThalaatha_dataSet,
    columns: [
      { data: 0, title: "#" },
      { data: 1, title: "އަރަބި ސުރުހީ" },
      { data: 2, title: "ދިވެހި ސުރުހީ" },
      { data: 3, title: "އަރަބި ނައްސު" },
      {
        data: 3,
      ...
      { data: 7, title: "شرح العثيمين" },
      { data: 8, title: "شرح ابن باز" },
    ],
    columnDefs: [
      {
        targets: [8, 9],
    ...
    language: {
      buttons: {
        copyTitle: "ކޮޕީ",
        copySuccess: { 1: "ކޮޕީ ވީ 1 ނުކުތާ", _: "ކޮޕީ ވީ %d ނުކުތާ" },
      },
    ...
    buttons: [
      {
        ...
        text: "ކޮޕީ",
        messageTop: "ޙަދީޘްއެމްވީ – އިސްލާމްކަން ގެއްލޭ ކަންކަން",
        title: "",
        customize(a) {
          a = a.replace(/\r\n\r\n/g, " ");
          a = a.replace(/\n\n/g, " ");
