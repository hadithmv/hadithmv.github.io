...
(function () {
  ...
  function k(
    value,
    convertIntoConstant,
    originalFromConstant,
    multValueByConstant
  ) {
    return inverse(
      inverse(value, convertIntoConstant, multValueByConstant),
      originalFromConstant,
      !multValueByConstant
    );
  }
  ...
  function Anything(keyName, keyValue, multiplyToKeyThenDivide, units) {
    var mtd =
      typeof multiplyToKeyThenDivide === "boolean"
        ? multiplyToKeyThenDivide
        : typeof keyValue === "boolean"
        ? keyValue
        : true; //Multiply then divide conversion algorithm, false will divide then multiply when converting "to".
    ...
    units =
      keyValue instanceof Array || keyValue instanceof Object
        ? keyValue
        : units; //Units available to convert "from" and "to", includes key/value
    var u = units || {}; //if "units" is undefined or null default it to an empty Object
    if (units instanceof Array) {
      //"units" can be passed in an array or object. Several UnitOf.Anything constructors accept an array of values to be passed serving as both the key and value of the unit. The following will turn that array into an Object as that is the format UnitOf.Anything uses behind the scenes.
      u = {};
      for (var i = 0; i < units.length; i++) {
        //Turn the array of units into an Object as that is the format UnitOf.Anything uses behind the scenes.
        u[units[i] + ""] = units[i] + "";
      }
    } else if (!(units instanceof Object)) {
      //if some other format besides Object or Array was passed in as the "units" overwrite it with an empty Object
      u = {};
    }
    ...
    return {
      ...
      convertNow: function (fromValue, fromName, toName) {
        return c(
          getUnitValueByName(fromName),
          fromValue,
          getUnitValueByName(toName)
        );
      },
    };
  }
  ...
  function DataType(v) {
    ...
    return {
      ...
      toBoolean: function (defaultValue, trueValues, caseSensitive, contains) {
        ...
        contains = trueValueShiftOne
          ? caseSensitive || false
          : contains || false;
        caseSensitive = trueValueShiftOne
          ? trueValues || false
          : caseSensitive || false;
        trueValues = trueValueShiftOne ? defaultValue : trueValues;
        defaultValue = trueValueShiftOne ? false : defaultValue || false;

        if (trueValues instanceof Array) {
          //Complex use of toBoolean. Use a collection of values to determine if the UnitOf.DataType variable exists within the collection.
          ...
          //Simple use of toBoolean. Tries to convert the value passed in the UnitOf.DataType() constructor into a boolean type. If this conversion fails the default value (which may be passed in as a parameter) is returned.
  ...
  function NumericBaseLogic(v, t) {
    ...
    function decimalToAnyBase(v, base) {
      var bi = bigInt(
        v.indexOf("-") === 0
          ? v.substring(1).toUpperCase().trim()
          : v.toUpperCase().trim()
      );
      var r;
      var s = "";
  ...
  function TemperatureLogic(v, t) {
    ...
    function fromCelsiusToType(val, t) {
      switch (t) {
        case "F":
          return val * 1.8 + 32; //Fahrenheit
        case "K":
          return val + 273.15; //Kelvin
        case "R":
          return (val + 273.15) * 1.8; //Rankine
        case "RE":
          return val * 0.8; //Reaumur
        default:
          return val; //Celsius
      }
    }
    ...
    function toCelsius(val, t) {
      switch (t) {
        case "F":
          return (val - 32) / 1.8; //Fahrenheit
        case "K":
          return val - 273.15; //Kelvin
        case "R":
          return (val - 491.67) * (5.0 / 9.0); //Rankine
        case "RE":
          return val * 1.25; //Reaumur
        default:
          return val; //Celsius
      }
    }
  ...
  UnitOf = {
    Acceleration: {
      fromAttometersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "AS");
      },
      fromCentimeterPerSecondSquared: function (v) {
        return AccelerationLogic(v, "CS");
      },
      fromDecimetersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "DS");
      },
      fromDekametersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "DAS");
      },
      fromExametersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "ES");
      },
      fromFeetPerHourPerSecond: function (v) {
        return AccelerationLogic(v, "FTHS");
      },
      fromFeetPerMinutePerSecond: function (v) {
        return AccelerationLogic(v, "FTMS");
      },
      fromFeetPerSecondSquared: function (v) {
        return AccelerationLogic(v, "FTS");
      },
      fromFemtometersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "FS");
      },
      fromGalileos: function (v) {
        return AccelerationLogic(v, "GAL");
      },
      fromGigametersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "GS");
      },
      fromGravity: function (v) {
        return AccelerationLogic(v, "G");
      },
      fromHectometersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "HS");
      },
      fromInchesPerMinutePerSecond: function (v) {
        return AccelerationLogic(v, "INMS");
      },
      fromInchesPerSecondSquared: function (v) {
        return AccelerationLogic(v, "INS");
      },
      fromKilometersPerHourPerSecond: function (v) {
        return AccelerationLogic(v, "KHS");
      },
      fromKilometersPerHourSquared: function (v) {
        return AccelerationLogic(v, "KH");
      },
      fromKilometersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "KS");
      },
      fromKnotsPerSecond: function (v) {
        return AccelerationLogic(v, "KNS");
      },
      fromMegametersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "MGS");
      },
      fromMetersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "MS");
      },
      fromMicrogalileos: function (v) {
        return AccelerationLogic(v, "MUGAL");
      },
      fromMicrometersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "MUS");
      },
      fromMilesPerHourPerSecond: function (v) {
        return AccelerationLogic(v, "MIHS");
      },
      fromMilesPerMinutePerSecond: function (v) {
        return AccelerationLogic(v, "MIMS");
      },
      fromMilesPerSecondSquared: function (v) {
        return AccelerationLogic(v, "MIS");
      },
      fromMilligalileos: function (v) {
        return AccelerationLogic(v, "MILGAL");
      },
      fromMillimetersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "MILS");
      },
      fromNanometersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "NS");
      },
      fromPetametersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "PES");
      },
      fromPicometersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "PS");
      },
      fromTerametersPerSecondSquared: function (v) {
        return AccelerationLogic(v, "TS");
      },
      fromYardsPerSecondSquared: function (v) {
        return AccelerationLogic(v, "YDS");
      },
    },
    Angle: {
      fromCircles: function (v) {
        return AngleLogic(v, "C");
      },
      fromDegrees: function (v) {
        return AngleLogic(v, "D");
      },
      fromGradians: function (v) {
        return AngleLogic(v, "G");
      },
      fromMils: function (v) {
        return AngleLogic(v, "MIL");
      },
      fromMinutes: function (v) {
        return AngleLogic(v, "M");
      },
      fromQuadrants: function (v) {
        return AngleLogic(v, "Q");
      },
      fromRadians: function (v) {
        return AngleLogic(v, "RAD");
      },
      fromRevolutions: function (v) {
        return AngleLogic(v, "R");
      },
      fromRightAngles: function (v) {
        return AngleLogic(v, "RA");
      },
      fromSeconds: function (v) {
        return AngleLogic(v, "S");
      },
      fromSextants: function (v) {
        return AngleLogic(v, "SE");
      },
      fromSigns: function (v) {
        return AngleLogic(v, "SI");
      },
      fromTurns: function (v) {
        return AngleLogic(v, "T");
      },
    },
    Anything: function (keyName, keyValue, multiplyToKeyThenDivide, units) {
      return Anything(keyName, keyValue, multiplyToKeyThenDivide, units);
    },
    Area: {
      fromAcres: function (v) {
        return AreaLogic(v, "AC");
      },
      fromAres: function (v) {
        return AreaLogic(v, "A");
      },
      fromArpents: function (v) {
        return AreaLogic(v, "AR");
      },
      fromBarns: function (v) {
        return AreaLogic(v, "B");
      },
      fromCircularInches: function (v) {
        return AreaLogic(v, "CRIN");
      },
      fromCircularMils: function (v) {
        return AreaLogic(v, "CRMIL");
      },
      fromHectares: function (v) {
        return AreaLogic(v, "HA");
      },
      fromHomesteads: function (v) {
        return AreaLogic(v, "HS");
      },
      fromRoods: function (v) {
        return AreaLogic(v, "R");
      },
      fromSabins: function (v) {
        return AreaLogic(v, "S");
      },
      fromSquareCentimeters: function (v) {
        return AreaLogic(v, "C");
      },
      fromSquareChains: function (v) {
        return AreaLogic(v, "CH");
      },
      fromSquareDecimeters: function (v) {
        return AreaLogic(v, "D");
      },
      fromSquareDekameters: function (v) {
        return AreaLogic(v, "DA");
      },
      fromSquareFeet: function (v) {
        return AreaLogic(v, "FT");
      },
      fromSquareHectometers: function (v) {
        return AreaLogic(v, "H");
      },
      fromSquareInches: function (v) {
        return AreaLogic(v, "IN");
      },
      fromSquareKilometers: function (v) {
        return AreaLogic(v, "K");
      },
      fromSquareMeters: function (v) {
        return AreaLogic(v, "M");
      },
      fromSquareMicrometers: function (v) {
        return AreaLogic(v, "MU");
      },
      fromSquareMiles: function (v) {
        return AreaLogic(v, "MI");
      },
      fromSquareMillimeters: function (v) {
        return AreaLogic(v, "MIL");
      },
      fromSquareNanometers: function (v) {
        return AreaLogic(v, "N");
      },
      fromSquarePerches: function (v) {
        return AreaLogic(v, "PE");
      },
      fromSquarePoles: function (v) {
        return AreaLogic(v, "PO");
      },
      fromSquareRods: function (v) {
        return AreaLogic(v, "ROD");
      },
      fromSquareYards: function (v) {
        return AreaLogic(v, "YD");
      },
    },
    DataStorage: {
      fromBits: function (v) {
        return DataStorageLogic(v, "B");
      },
      fromBlocks: function (v) {
        return DataStorageLogic(v, "BL");
      },
      fromBluRay_DoubleLayer: function (v) {
        return DataStorageLogic(v, "BD2");
      },
      fromBluRay_SingleLayer: function (v) {
        return DataStorageLogic(v, "BD1");
      },
      fromBytes: function (v) {
        return DataStorageLogic(v, "BY");
      },
      fromCDs_74Minutes: function (v) {
        return DataStorageLogic(v, "CD74");
      },
      fromCDs_80Minutes: function (v) {
        return DataStorageLogic(v, "CD80");
      },
      fromDVDs_DoubleSidedDoubleLayer: function (v) {
        return DataStorageLogic(v, "D22");
      },
      fromDVDs_DoubleSidedSingleLayer: function (v) {
        return DataStorageLogic(v, "D12");
      },
      fromDVDs_SingleSidedDoubleLayer: function (v) {
        return DataStorageLogic(v, "D21");
      },
      fromDVDs_SingleSidedSingleLayer: function (v) {
        return DataStorageLogic(v, "D11");
      },
      fromExabits: function (v) {
        return DataStorageLogic(v, "EBI");
      },
      fromExabytes: function (v) {
        return DataStorageLogic(v, "EB");
      },
      fromFloppyDisks_35DD: function (v) {
        return DataStorageLogic(v, "F35DD");
      },
      fromFloppyDisks_35ED: function (v) {
        return DataStorageLogic(v, "F35ED");
      },
      fromFloppyDisks_35HD: function (v) {
        return DataStorageLogic(v, "F35HD");
      },
      fromFloppyDisks_525DD: function (v) {
        return DataStorageLogic(v, "F525DD");
      },
      fromFloppyDisks_525HD: function (v) {
        return DataStorageLogic(v, "F525HD");
      },
      fromGigabits: function (v) {
        return DataStorageLogic(v, "GBI");
      },
      fromGigabytes: function (v) {
        return DataStorageLogic(v, "GB");
      },
      fromKilobits: function (v) {
        return DataStorageLogic(v, "KBI");
      },
      fromKilobytes: function (v) {
        return DataStorageLogic(v, "KB");
      },
      fromMegabits: function (v) {
        return DataStorageLogic(v, "MBI");
      },
      fromMegabytes: function (v) {
        return DataStorageLogic(v, "MB");
      },
      fromNibbles: function (v) {
        return DataStorageLogic(v, "NI");
      },
      fromPetabits: function (v) {
        return DataStorageLogic(v, "PBI");
      },
      fromPetabytes: function (v) {
        return DataStorageLogic(v, "PB");
      },
      fromSIUnitExabits: function (v) {
        return DataStorageLogic(v, "SIEBI");
      },
      fromSIUnitExabytes: function (v) {
        return DataStorageLogic(v, "SIEB");
      },
      fromSIUnitGigabits: function (v) {
        return DataStorageLogic(v, "SIGBI");
      },
      fromSIUnitGigabytes: function (v) {
        return DataStorageLogic(v, "SIGB");
      },
      fromSIUnitKilobits: function (v) {
        return DataStorageLogic(v, "SIKBI");
      },
      fromSIUnitKilobytes: function (v) {
        return DataStorageLogic(v, "SIKB");
      },
      fromSIUnitMegabits: function (v) {
        return DataStorageLogic(v, "SIMBI");
      },
      fromSIUnitMegabytes: function (v) {
        return DataStorageLogic(v, "SIMB");
      },
      fromSIUnitPetabits: function (v) {
        return DataStorageLogic(v, "SIPBI");
      },
      fromSIUnitPetabytes: function (v) {
        return DataStorageLogic(v, "SIPB");
      },
      fromSIUnitTerabits: function (v) {
        return DataStorageLogic(v, "SITBI");
      },
      fromSIUnitTerabytes: function (v) {
        return DataStorageLogic(v, "SITB");
      },
      fromSIUnitYottabits: function (v) {
        return DataStorageLogic(v, "SIYBI");
      },
      fromSIUnitYottabytes: function (v) {
        return DataStorageLogic(v, "SIYB");
      },
      fromSIUnitZettabits: function (v) {
        return DataStorageLogic(v, "SIZBI");
      },
      fromSIUnitZettabytes: function (v) {
        return DataStorageLogic(v, "SIZB");
      },
      fromTerabits: function (v) {
        return DataStorageLogic(v, "TBI");
      },
      fromTerabytes: function (v) {
        return DataStorageLogic(v, "TB");
      },
      fromWords: function (v) {
        return DataStorageLogic(v, "W");
      },
      fromYottabits: function (v) {
        return DataStorageLogic(v, "YBI");
      },
      fromYottabytes: function (v) {
        return DataStorageLogic(v, "YB");
      },
      fromZettabits: function (v) {
        return DataStorageLogic(v, "ZBI");
      },
      fromZettabytes: function (v) {
        return DataStorageLogic(v, "ZB");
      },
    },
    DataTransferRate: {
      fromBitsPerSecond: function (v) {
        return DataTransferRateLogic(v, "BIS");
      },
      fromBytesPerSecond: function (v) {
        return DataTransferRateLogic(v, "BS");
      },
      fromEthernetsBase10: function (v) {
        return DataTransferRateLogic(v, "E10");
      },
      fromEthernetsBase100: function (v) {
        return DataTransferRateLogic(v, "E100");
      },
      fromEthernetsBase1000: function (v) {
        return DataTransferRateLogic(v, "E1000");
      },
      fromFireWires400: function (v) {
        return DataTransferRateLogic(v, "FW400");
      },
      fromFireWires800: function (v) {
        return DataTransferRateLogic(v, "FW800");
      },
      fromFireWiresS1600_S3200: function (v) {
        return DataTransferRateLogic(v, "FW3200");
      },
      fromGigabitsPerSecond: function (v) {
        return DataTransferRateLogic(v, "GBIS");
      },
      fromGigabytesPerSecond: function (v) {
        return DataTransferRateLogic(v, "GBS");
      },
      fromISDNsDual: function (v) {
        return DataTransferRateLogic(v, "ISDND");
      },
      fromISDNsSingle: function (v) {
        return DataTransferRateLogic(v, "ISDNS");
      },
      fromKilobitsPerSecond: function (v) {
        return DataTransferRateLogic(v, "KBIS");
      },
      fromKilobytesPerSecond: function (v) {
        return DataTransferRateLogic(v, "KBS");
      },
      fromMegabitsPerSecond: function (v) {
        return DataTransferRateLogic(v, "MBIS");
      },
      fromMegabytesPerSecond: function (v) {
        return DataTransferRateLogic(v, "MBS");
      },
      fromModems110b: function (v) {
        return DataTransferRateLogic(v, "M110");
      },
      fromModems1200b: function (v) {
        return DataTransferRateLogic(v, "M1200");
      },
      fromModems14_4k: function (v) {
        return DataTransferRateLogic(v, "M14K");
      },
      fromModems2400b: function (v) {
        return DataTransferRateLogic(v, "M2400");
      },
      fromModems28_8k: function (v) {
        return DataTransferRateLogic(v, "M28K");
      },
      fromModems300b: function (v) {
        return DataTransferRateLogic(v, "M300");
      },
      fromModems33_6k: function (v) {
        return DataTransferRateLogic(v, "M33K");
      },
      fromModems56k: function (v) {
        return DataTransferRateLogic(v, "M56K");
      },
      fromModems9600b: function (v) {
        return DataTransferRateLogic(v, "M9600");
      },
      fromOCs1: function (v) {
        return DataTransferRateLogic(v, "OC1");
      },
      fromOCs12: function (v) {
        return DataTransferRateLogic(v, "OC12");
      },
      fromOCs192: function (v) {
        return DataTransferRateLogic(v, "OC192");
      },
      fromOCs24: function (v) {
        return DataTransferRateLogic(v, "OC24");
      },
      fromOCs3: function (v) {
        return DataTransferRateLogic(v, "OC3");
      },
      fromOCs48: function (v) {
        return DataTransferRateLogic(v, "OC48");
      },
      fromOCs768: function (v) {
        return DataTransferRateLogic(v, "OC768");
      },
      fromPetabitsPerSecond: function (v) {
        return DataTransferRateLogic(v, "PBIS");
      },
      fromPetabytesPerSecond: function (v) {
        return DataTransferRateLogic(v, "PBS");
      },
      fromSIUnitGigabitsPerSecond: function (v) {
        return DataTransferRateLogic(v, "SIGBIS");
      },
      fromSIUnitGigabytesPerSecond: function (v) {
        return DataTransferRateLogic(v, "SIGBS");
      },
      fromSIUnitKilobitsPerSecond: function (v) {
        return DataTransferRateLogic(v, "SIKBIS");
      },
      fromSIUnitKilobytesPerSecond: function (v) {
        return DataTransferRateLogic(v, "SIKBS");
      },
      fromSIUnitMegabitsPerSecond: function (v) {
        return DataTransferRateLogic(v, "SIMBIS");
      },
      fromSIUnitMegabytesPerSecond: function (v) {
        return DataTransferRateLogic(v, "SIMBS");
      },
      fromSIUnitPetabitsPerSecond: function (v) {
        return DataTransferRateLogic(v, "SIPBIS");
      },
      fromSIUnitPetabytesPerSecond: function (v) {
        return DataTransferRateLogic(v, "SIPBS");
      },
      fromSIUnitTerabitsPerSecond: function (v) {
        return DataTransferRateLogic(v, "SITBIS");
      },
      fromSIUnitTerabytesPerSecond: function (v) {
        return DataTransferRateLogic(v, "SITBS");
      },
      fromTerabitsPerSecond: function (v) {
        return DataTransferRateLogic(v, "TBIS");
      },
      fromTerabytesPerSecond: function (v) {
        return DataTransferRateLogic(v, "TBS");
      },
      fromUSBs1_0: function (v) {
        return DataTransferRateLogic(v, "USB1");
      },
      fromUSBs2_0: function (v) {
        return DataTransferRateLogic(v, "USB2");
      },
      fromUSBs3_0: function (v) {
        return DataTransferRateLogic(v, "USB3");
      },
      fromUSBs3_1: function (v) {
        return DataTransferRateLogic(v, "USB31");
      },
    },
    DataType: function (v) {
      return DataType(v);
    ...
    ElectricCharge: {
      fromAbcoulombs: function (v) {
        return ElectricChargeLogic(v, "ABC");
      },
      fromAmpereHours: function (v) {
        return ElectricChargeLogic(v, "AH");
      },
      fromAmpereMinutes: function (v) {
        return ElectricChargeLogic(v, "AM");
      },
      fromAmpereSeconds: function (v) {
        return ElectricChargeLogic(v, "AS");
      },
      fromCoulombs: function (v) {
        return ElectricChargeLogic(v, "C");
      },
      fromEMUsOfCharge: function (v) {
        return ElectricChargeLogic(v, "EMU");
      },
      fromESUsOfCharge: function (v) {
        return ElectricChargeLogic(v, "ESU");
      },
      fromElectronCharge: function (v) {
        return ElectricChargeLogic(v, "E");
      },
      fromFaradVolts: function (v) {
        return ElectricChargeLogic(v, "F");
      },
      fromFaradayCarbon12: function (v) {
        return ElectricChargeLogic(v, "FA12");
      },
      fromFaradayChemistry: function (v) {
        return ElectricChargeLogic(v, "FACH");
      },
      fromFaradayPhysics: function (v) {
        return ElectricChargeLogic(v, "FAPH");
      },
      fromFranklins: function (v) {
        return ElectricChargeLogic(v, "FR");
      },
      fromKilocoulombs: function (v) {
        return ElectricChargeLogic(v, "KC");
      },
      fromMegacoulombs: function (v) {
        return ElectricChargeLogic(v, "MC");
      },
      fromMicrocoulombs: function (v) {
        return ElectricChargeLogic(v, "MUC");
      },
      fromMillicoulombs: function (v) {
        return ElectricChargeLogic(v, "MILC");
      },
      fromNanocoulombs: function (v) {
        return ElectricChargeLogic(v, "NC");
      },
      fromPicocoulombs: function (v) {
        return ElectricChargeLogic(v, "PC");
      },
      fromStatcoulombs: function (v) {
        return ElectricChargeLogic(v, "STC");
      },
    },
    Energy: {
      fromAttojoules: function (v) {
        return EnergyLogic(v, "AJ");
      },
      fromBTUsInternationalStandard: function (v) {
        return EnergyLogic(v, "BTU");
      },
      fromBTUsThermochemical: function (v) {
        return EnergyLogic(v, "BTUTH");
      },
      fromBarrelsOfOilEquivalent: function (v) {
        return EnergyLogic(v, "BOE");
      },
      fromCaloriesInternationalSteam: function (v) {
        return EnergyLogic(v, "CALIT");
      },
      fromCaloriesNutritional: function (v) {
        return EnergyLogic(v, "CALN");
      },
      fromCaloriesThermochemical: function (v) {
        return EnergyLogic(v, "CALTH");
      },
      fromDyneCentimeters: function (v) {
        return EnergyLogic(v, "DYNCM");
      },
      fromElectronVolts: function (v) {
        return EnergyLogic(v, "EV");
      },
      fromErgs: function (v) {
        return EnergyLogic(v, "ERG");
      },
      fromFootPounds: function (v) {
        return EnergyLogic(v, "FTLBF");
      },
      fromGigajoules: function (v) {
        return EnergyLogic(v, "GJ");
      },
      fromGigatonsOfTNT: function (v) {
        return EnergyLogic(v, "GT");
      },
      fromGigawattHours: function (v) {
        return EnergyLogic(v, "GWH");
      },
      fromGramForceCentimeters: function (v) {
        return EnergyLogic(v, "GFCM");
      },
      fromGramForceMeters: function (v) {
        return EnergyLogic(v, "GFM");
      },
      fromHartrees: function (v) {
        return EnergyLogic(v, "H");
      },
      fromHorsepowerHours: function (v) {
        return EnergyLogic(v, "HPH");
      },
      fromHorsepowerHoursMetric: function (v) {
        return EnergyLogic(v, "HPHM");
      },
      fromInchOunces: function (v) {
        return EnergyLogic(v, "INOZF");
      },
      fromInchPounds: function (v) {
        return EnergyLogic(v, "INLBF");
      },
      fromJoules: function (v) {
        return EnergyLogic(v, "J");
      },
      fromKilocaloriesInternationalSteam: function (v) {
        return EnergyLogic(v, "KCALIT");
      },
      fromKilocaloriesThermochemical: function (v) {
        return EnergyLogic(v, "KCALTH");
      },
      fromKiloelectronVolts: function (v) {
        return EnergyLogic(v, "KEV");
      },
      fromKilogramForceCentimeters: function (v) {
        return EnergyLogic(v, "KGFCM");
      },
      fromKilogramForceMeters: function (v) {
        return EnergyLogic(v, "KGFM");
      },
      fromKilogramsOfTNT: function (v) {
        return EnergyLogic(v, "KGT");
      },
      fromKilojoules: function (v) {
        return EnergyLogic(v, "KJ");
      },
      fromKilopondMeters: function (v) {
        return EnergyLogic(v, "KPM");
      },
      fromKilotonsOfTNT: function (v) {
        return EnergyLogic(v, "KT");
      },
      fromKilowattHours: function (v) {
        return EnergyLogic(v, "KWH");
      },
      fromKilowattSeconds: function (v) {
        return EnergyLogic(v, "KWS");
      },
      fromLiterAtmospheres: function (v) {
        return EnergyLogic(v, "LA");
      },
      fromMegaBTUsInternationalStandard: function (v) {
        return EnergyLogic(v, "MBTU");
      },
      fromMegaelectronVolts: function (v) {
        return EnergyLogic(v, "MEV");
      },
      fromMegajoules: function (v) {
        return EnergyLogic(v, "MJ");
      },
      fromMegatonsOfTNT: function (v) {
        return EnergyLogic(v, "MT");
      },
      fromMegawattHours: function (v) {
        return EnergyLogic(v, "MWH");
      },
      fromMicrojoules: function (v) {
        return EnergyLogic(v, "MUJ");
      },
      fromMillijoules: function (v) {
        return EnergyLogic(v, "MILJ");
      },
      fromNanojoules: function (v) {
        return EnergyLogic(v, "NJ");
      },
      fromNewtonMeters: function (v) {
        return EnergyLogic(v, "NM");
      },
      fromPlanckEnergy: function (v) {
        return EnergyLogic(v, "EP");
      },
      fromPoundalFeet: function (v) {
        return EnergyLogic(v, "PDLFT");
      },
      fromRydbergs: function (v) {
        return EnergyLogic(v, "RY");
      },
      fromThermsEC: function (v) {
        return EnergyLogic(v, "THMEC");
      },
      fromThermsUS: function (v) {
        return EnergyLogic(v, "THMUS");
      },
      fromTonsOfTNT: function (v) {
        return EnergyLogic(v, "TT");
      },
      fromWattHours: function (v) {
        return EnergyLogic(v, "WH");
      },
      fromWattSeconds: function (v) {
        return EnergyLogic(v, "WS");
      },
    },
    Force: {
      fromAtomicUnitsOfForce: function (v) {
        return ForceLogic(v, "AUF");
      },
      fromAttonewtons: function (v) {
        return ForceLogic(v, "AN");
      },
      fromCentinewtons: function (v) {
        return ForceLogic(v, "CN");
      },
      fromDecinewtons: function (v) {
        return ForceLogic(v, "DN");
      },
      fromDekanewtons: function (v) {
        return ForceLogic(v, "DAN");
      },
      fromDynes: function (v) {
        return ForceLogic(v, "DYN");
      },
      fromExanewtons: function (v) {
        return ForceLogic(v, "EN");
      },
      fromFemtonewtons: function (v) {
        return ForceLogic(v, "FN");
      },
      fromGiganewtons: function (v) {
        return ForceLogic(v, "GN");
      },
      fromGramForces: function (v) {
        return ForceLogic(v, "GF");
      },
      fromGraveForces: function (v) {
        return ForceLogic(v, "GFF");
      },
      fromHectonewtons: function (v) {
        return ForceLogic(v, "HN");
      },
      fromJouleCentimeters: function (v) {
        return ForceLogic(v, "JCM");
      },
      fromJouleMeters: function (v) {
        return ForceLogic(v, "JM");
      },
      fromKilogramForces: function (v) {
        return ForceLogic(v, "KGF");
      },
      fromKilonewtons: function (v) {
        return ForceLogic(v, "KN");
      },
      fromKiloponds: function (v) {
        return ForceLogic(v, "KP");
      },
      fromKilopoundForces: function (v) {
        return ForceLogic(v, "KIP");
      },
      fromLongTonForces: function (v) {
        return ForceLogic(v, "LTF");
      },
      fromMeganewtons: function (v) {
        return ForceLogic(v, "MN");
      },
      fromMetricTonForces: function (v) {
        return ForceLogic(v, "TFM");
      },
      fromMicronewtons: function (v) {
        return ForceLogic(v, "MUN");
      },
      fromMilligraveForces: function (v) {
        return ForceLogic(v, "MGF");
      },
      fromMillinewtons: function (v) {
        return ForceLogic(v, "MILN");
      },
      fromNanonewtons: function (v) {
        return ForceLogic(v, "NN");
      },
      fromNewtons: function (v) {
        return ForceLogic(v, "N");
      },
      fromOunceForces: function (v) {
        return ForceLogic(v, "OZF");
      },
      fromPetanewtons: function (v) {
        return ForceLogic(v, "PEN");
      },
      fromPiconewtons: function (v) {
        return ForceLogic(v, "PN");
      },
      fromPonds: function (v) {
        return ForceLogic(v, "P");
      },
      fromPoundFeetPerSecondSquared: function (v) {
        return ForceLogic(v, "LBFT");
      },
      fromPoundForces: function (v) {
        return ForceLogic(v, "LBF");
      },
      fromPoundals: function (v) {
        return ForceLogic(v, "PDL");
      },
      fromShortTonForces: function (v) {
        return ForceLogic(v, "TFS");
      },
      fromSthenes: function (v) {
        return ForceLogic(v, "SN");
      },
      fromTeranewtons: function (v) {
        return ForceLogic(v, "TN");
      },
    },
    Frequency: {
      fromAttohertz: function (v) {
        return FrequencyLogic(v, "AHZ");
      },
      fromCentihertz: function (v) {
        return FrequencyLogic(v, "CHZ");
      },
      fromCyclesPerSecond: function (v) {
        return FrequencyLogic(v, "CS");
      },
      fromDecihertz: function (v) {
        return FrequencyLogic(v, "DHZ");
      },
      fromDekahertz: function (v) {
        return FrequencyLogic(v, "DAHZ");
      },
      fromExahertz: function (v) {
        return FrequencyLogic(v, "EHZ");
      },
      fromFemtohertz: function (v) {
        return FrequencyLogic(v, "FHZ");
      },
      fromGigahertz: function (v) {
        return FrequencyLogic(v, "GHZ");
      },
      fromHectohertz: function (v) {
        return FrequencyLogic(v, "HHZ");
      },
      fromHertz: function (v) {
        return FrequencyLogic(v, "HZ");
      },
      fromKilohertz: function (v) {
        return FrequencyLogic(v, "KHZ");
      },
      fromMegahertz: function (v) {
        return FrequencyLogic(v, "MHZ");
      },
      fromMicrohertz: function (v) {
        return FrequencyLogic(v, "MUHZ");
      },
      fromMillihertz: function (v) {
        return FrequencyLogic(v, "MIHZ");
      },
      fromNanohertz: function (v) {
        return FrequencyLogic(v, "NHZ");
      },
      fromPetahertz: function (v) {
        return FrequencyLogic(v, "PEHZ");
      },
      fromPicohertz: function (v) {
        return FrequencyLogic(v, "PHZ");
      },
      fromRevolutionsPerDay: function (v) {
        return FrequencyLogic(v, "RD");
      },
      fromRevolutionsPerHour: function (v) {
        return FrequencyLogic(v, "RH");
      },
      fromRevolutionsPerMinute: function (v) {
        return FrequencyLogic(v, "RM");
      },
      fromRevolutionsPerSecond: function (v) {
        return FrequencyLogic(v, "RS");
      },
      fromTerahertz: function (v) {
        return FrequencyLogic(v, "THZ");
      },
    },
    FuelEconomy: {
      fromCentimetersPerLiter: function (v) {
        return FuelEconomyLogic(v, "CML");
      },
      fromDekametersPerLiter: function (v) {
        return FuelEconomyLogic(v, "DAML");
      },
      fromExametersPerLiter: function (v) {
        return FuelEconomyLogic(v, "EML");
      },
      fromGigametersPerLiter: function (v) {
        return FuelEconomyLogic(v, "GML");
      },
      fromHectometersPerLiter: function (v) {
        return FuelEconomyLogic(v, "HML");
      },
      fromKilometersPerGallonUK: function (v) {
        return FuelEconomyLogic(v, "KMGALUK");
      },
      fromKilometersPerGallonUS: function (v) {
        return FuelEconomyLogic(v, "KMGALUS");
      },
      fromKilometersPerLiter: function (v) {
        return FuelEconomyLogic(v, "KML");
      },
      fromMegametersPerLiter: function (v) {
        return FuelEconomyLogic(v, "MML");
      },
      fromMetersPerCubicCentimeter: function (v) {
        return FuelEconomyLogic(v, "MCM");
      },
      fromMetersPerCubicFoot: function (v) {
        return FuelEconomyLogic(v, "MFT");
      },
      fromMetersPerCubicInch: function (v) {
        return FuelEconomyLogic(v, "MIN");
      },
      fromMetersPerCubicMeter: function (v) {
        return FuelEconomyLogic(v, "MM");
      },
      fromMetersPerCubicYard: function (v) {
        return FuelEconomyLogic(v, "MYD");
      },
      fromMetersPerCupUK: function (v) {
        return FuelEconomyLogic(v, "MCUPUK");
      },
      fromMetersPerCupUS: function (v) {
        return FuelEconomyLogic(v, "MCUPUS");
      },
      fromMetersPerFluidOunceUK: function (v) {
        return FuelEconomyLogic(v, "MFOZUK");
      },
      fromMetersPerFluidOunceUS: function (v) {
        return FuelEconomyLogic(v, "MFOZUS");
      },
      fromMetersPerGallonUK: function (v) {
        return FuelEconomyLogic(v, "MGALUK");
      },
      fromMetersPerGallonUS: function (v) {
        return FuelEconomyLogic(v, "MGALUS");
      },
      fromMetersPerLiter: function (v) {
        return FuelEconomyLogic(v, "ML");
      },
      fromMetersPerPintUK: function (v) {
        return FuelEconomyLogic(v, "MPTUK");
      },
      fromMetersPerPintUS: function (v) {
        return FuelEconomyLogic(v, "MPTUS");
      },
      fromMetersPerQuartUK: function (v) {
        return FuelEconomyLogic(v, "MQTUK");
      },
      fromMetersPerQuartUS: function (v) {
        return FuelEconomyLogic(v, "MQTUS");
      },
      fromMilesPerGallonUK: function (v) {
        return FuelEconomyLogic(v, "MIGALUK");
      },
      fromMilesPerGallonUS: function (v) {
        return FuelEconomyLogic(v, "MIGALUS");
      },
      fromMilesPerLiterUS: function (v) {
        return FuelEconomyLogic(v, "MIL");
      },
      fromNauticalMilesPerGallonUS: function (v) {
        return FuelEconomyLogic(v, "NMIGAL");
      },
      fromNauticalMilesPerLiter: function (v) {
        return FuelEconomyLogic(v, "NMIL");
      },
      fromPetametersPerLiter: function (v) {
        return FuelEconomyLogic(v, "PML");
      },
      fromTerametersPerLiter: function (v) {
        return FuelEconomyLogic(v, "TML");
      },
    },
    Length: {
      fromAngstroms: function (v) {
        return LengthLogic(v, "A");
      },
      fromAttometers: function (v) {
        return LengthLogic(v, "AM");
      },
      fromBarleycorns: function (v) {
        return LengthLogic(v, "BC");
      },
      fromCablesImperial: function (v) {
        return LengthLogic(v, "CBLIMP");
      },
      fromCablesInternational: function (v) {
        return LengthLogic(v, "CBLIN");
      },
      fromCablesUSCustomary: function (v) {
        return LengthLogic(v, "CBLUS");
      },
      fromCaliber: function (v) {
        return LengthLogic(v, "CL");
      },
      fromCentiinches: function (v) {
        return LengthLogic(v, "CIN");
      },
      fromCentimeters: function (v) {
        return LengthLogic(v, "CM");
      },
      fromChains: function (v) {
        return LengthLogic(v, "CH");
      },
      fromCubits: function (v) {
        return LengthLogic(v, "CU");
      },
      fromDecimeters: function (v) {
        return LengthLogic(v, "DM");
      },
      fromDekameters: function (v) {
        return LengthLogic(v, "DAM");
      },
      fromElls: function (v) {
        return LengthLogic(v, "ELL");
      },
      fromExameters: function (v) {
        return LengthLogic(v, "EM");
      },
      fromFathoms: function (v) {
        return LengthLogic(v, "FTM");
      },
      fromFeet: function (v) {
        return LengthLogic(v, "FT");
      },
      fromFemtometers: function (v) {
        return LengthLogic(v, "FM");
      },
      fromFingers: function (v) {
        return LengthLogic(v, "FING");
      },
      fromFurlongs: function (v) {
        return LengthLogic(v, "FUR");
      },
      fromGigameters: function (v) {
        return LengthLogic(v, "GM");
      },
      fromHands: function (v) {
        return LengthLogic(v, "HAND");
      },
      fromHectometers: function (v) {
        return LengthLogic(v, "HM");
      },
      fromInches: function (v) {
        return LengthLogic(v, "IN");
      },
      fromKilometers: function (v) {
        return LengthLogic(v, "KM");
      },
      fromKiloyards: function (v) {
        return LengthLogic(v, "KYD");
      },
      fromLeagues: function (v) {
        return LengthLogic(v, "LEA");
      },
      fromLightYears: function (v) {
        return LengthLogic(v, "LY");
      },
      fromLinks: function (v) {
        return LengthLogic(v, "LNK");
      },
      fromMegameters: function (v) {
        return LengthLogic(v, "MM");
      },
      fromMeters: function (v) {
        return LengthLogic(v, "M");
      },
      fromMicroinches: function (v) {
        return LengthLogic(v, "MUIN");
      },
      fromMicrometers: function (v) {
        return LengthLogic(v, "MUM");
      },
      fromMicrons: function (v) {
        return LengthLogic(v, "MURM");
      },
      fromMiles: function (v) {
        return LengthLogic(v, "MI");
      },
      fromMillimeters: function (v) {
        return LengthLogic(v, "MILM");
      },
      fromNails: function (v) {
        return LengthLogic(v, "NAIL");
      },
      fromNanometers: function (v) {
        return LengthLogic(v, "NM");
      },
      fromNauticalLeaguesInternational: function (v) {
        return LengthLogic(v, "NLEAIN");
      },
      fromNauticalLeaguesUK: function (v) {
        return LengthLogic(v, "NLEAUK");
      },
      fromNauticalMilesInternational: function (v) {
        return LengthLogic(v, "NMIINT");
      },
      fromNauticalMilesUK: function (v) {
        return LengthLogic(v, "NMIUK");
      },
      fromNauticalMilesUSCustomary: function (v) {
        return LengthLogic(v, "NMIUS");
      },
      fromPerches: function (v) {
        return LengthLogic(v, "PER");
      },
      fromPetameters: function (v) {
        return LengthLogic(v, "PEM");
      },
      fromPicometers: function (v) {
        return LengthLogic(v, "PM");
      },
      fromPoles: function (v) {
        return LengthLogic(v, "POL");
      },
      fromRods: function (v) {
        return LengthLogic(v, "RD");
      },
      fromRopes: function (v) {
        return LengthLogic(v, "ROPE");
      },
      fromSpans: function (v) {
        return LengthLogic(v, "SPAN");
      },
      fromTerameters: function (v) {
        return LengthLogic(v, "TM");
      },
      fromThousandthInches: function (v) {
        return LengthLogic(v, "TIN");
      },
      fromYards: function (v) {
        return LengthLogic(v, "YD");
      },
    },
    Mass: {
      fromAttograms: function (v) {
        return MassLogic(v, "AG");
      },
      fromCarats: function (v) {
        return MassLogic(v, "CT");
      },
      fromCentigrams: function (v) {
        return MassLogic(v, "CG");
      },
      fromCentners: function (v) {
        return MassLogic(v, "CWT");
      },
      fromDecigrams: function (v) {
        return MassLogic(v, "DG");
      },
      fromDekagrams: function (v) {
        return MassLogic(v, "DAG");
      },
      fromExagrams: function (v) {
        return MassLogic(v, "EG");
      },
      fromFemtograms: function (v) {
        return MassLogic(v, "FG");
      },
      fromGamma: function (v) {
        return MassLogic(v, "GAMM");
      },
      fromGigagrams: function (v) {
        return MassLogic(v, "GG");
      },
      fromGrams: function (v) {
        return MassLogic(v, "G");
      },
      fromHectograms: function (v) {
        return MassLogic(v, "HG");
      },
      fromKilograms: function (v) {
        return MassLogic(v, "KG");
      },
      fromKilopounds: function (v) {
        return MassLogic(v, "KIP");
      },
      fromKilotonsMetric: function (v) {
        return MassLogic(v, "TK");
      },
      fromMegagrams: function (v) {
        return MassLogic(v, "MG");
      },
      fromMicrograms: function (v) {
        return MassLogic(v, "MUG");
      },
      fromMilligrams: function (v) {
        return MassLogic(v, "MILG");
      },
      fromNanograms: function (v) {
        return MassLogic(v, "NG");
      },
      fromOuncesMetric: function (v) {
        return MassLogic(v, "MOZ");
      },
      fromOuncesUS: function (v) {
        return MassLogic(v, "USOZ");
      },
      fromPetagrams: function (v) {
        return MassLogic(v, "PEG");
      },
      fromPicograms: function (v) {
        return MassLogic(v, "PG");
      },
      fromPounds: function (v) {
        return MassLogic(v, "LB");
      },
      fromQuintals: function (v) {
        return MassLogic(v, "QU");
      },
      fromSlugs: function (v) {
        return MassLogic(v, "SLUG");
      },
      fromStonesUK: function (v) {
        return MassLogic(v, "STUK");
      },
      fromStonesUS: function (v) {
        return MassLogic(v, "STUS");
      },
      fromTeragrams: function (v) {
        return MassLogic(v, "TG");
      },
      fromTonsImperial: function (v) {
        return MassLogic(v, "TI");
      },
      fromTonsMetric: function (v) {
        return MassLogic(v, "TM");
      },
      fromTonsUS: function (v) {
        return MassLogic(v, "TUS");
      },
    },
    MetricPrefix: {
      fromAtto: function (v) {
        return MetricPrefixLogic(v, "A");
      },
      fromCenti: function (v) {
        return MetricPrefixLogic(v, "C");
      },
      fromDeci: function (v) {
        return MetricPrefixLogic(v, "D");
      },
      fromDeka: function (v) {
        return MetricPrefixLogic(v, "DA");
      },
      fromExa: function (v) {
        return MetricPrefixLogic(v, "E");
      },
      fromFemto: function (v) {
        return MetricPrefixLogic(v, "F");
      },
      fromGiga: function (v) {
        return MetricPrefixLogic(v, "G");
      },
      fromHecto: function (v) {
        return MetricPrefixLogic(v, "H");
      },
      fromKilo: function (v) {
        return MetricPrefixLogic(v, "K");
      },
      fromMega: function (v) {
        return MetricPrefixLogic(v, "M");
      },
      fromMicro: function (v) {
        return MetricPrefixLogic(v, "MU");
      },
      fromMilli: function (v) {
        return MetricPrefixLogic(v, "MIL");
      },
      fromNano: function (v) {
        return MetricPrefixLogic(v, "N");
      },
      fromNoPrefix: function (v) {
        return MetricPrefixLogic(v, "NN");
      },
      fromPeta: function (v) {
        return MetricPrefixLogic(v, "PE");
      },
      fromPico: function (v) {
        return MetricPrefixLogic(v, "P");
      },
      fromTera: function (v) {
        return MetricPrefixLogic(v, "T");
      },
      fromYocto: function (v) {
        return MetricPrefixLogic(v, "YO");
      },
      fromYotta: function (v) {
        return MetricPrefixLogic(v, "Y");
      },
      fromZepto: function (v) {
        return MetricPrefixLogic(v, "ZO");
      },
      fromZetta: function (v) {
        return MetricPrefixLogic(v, "Z");
      },
    },
    NumericBase: {
      fromBase11: function (v) {
        return NumericBaseLogic(v, "B11");
      },
      fromBase12: function (v) {
        return NumericBaseLogic(v, "B12");
      },
      fromBase13: function (v) {
        return NumericBaseLogic(v, "B13");
      },
      fromBase14: function (v) {
        return NumericBaseLogic(v, "B14");
      },
      fromBase15: function (v) {
        return NumericBaseLogic(v, "B15");
      },
      fromBase17: function (v) {
        return NumericBaseLogic(v, "B17");
      },
      fromBase18: function (v) {
        return NumericBaseLogic(v, "B18");
      },
      fromBase19: function (v) {
        return NumericBaseLogic(v, "B19");
      },
      fromBase20: function (v) {
        return NumericBaseLogic(v, "B20");
      },
      fromBase21: function (v) {
        return NumericBaseLogic(v, "B21");
      },
      fromBase22: function (v) {
        return NumericBaseLogic(v, "B22");
      },
      fromBase23: function (v) {
        return NumericBaseLogic(v, "B23");
      },
      fromBase24: function (v) {
        return NumericBaseLogic(v, "B24");
      },
      fromBase25: function (v) {
        return NumericBaseLogic(v, "B25");
      },
      fromBase26: function (v) {
        return NumericBaseLogic(v, "B26");
      },
      fromBase27: function (v) {
        return NumericBaseLogic(v, "B27");
      },
      fromBase28: function (v) {
        return NumericBaseLogic(v, "B28");
      },
      fromBase29: function (v) {
        return NumericBaseLogic(v, "B29");
      },
      fromBase3: function (v) {
        return NumericBaseLogic(v, "B3");
      },
      fromBase30: function (v) {
        return NumericBaseLogic(v, "B30");
      },
      fromBase31: function (v) {
        return NumericBaseLogic(v, "B31");
      },
      fromBase32: function (v) {
        return NumericBaseLogic(v, "B32");
      },
      fromBase33: function (v) {
        return NumericBaseLogic(v, "B33");
      },
      fromBase34: function (v) {
        return NumericBaseLogic(v, "B34");
      },
      fromBase35: function (v) {
        return NumericBaseLogic(v, "B35");
      },
      fromBase36: function (v) {
        return NumericBaseLogic(v, "B36");
      },
      fromBase4: function (v) {
        return NumericBaseLogic(v, "B4");
      },
      fromBase5: function (v) {
        return NumericBaseLogic(v, "B5");
      },
      fromBase6: function (v) {
        return NumericBaseLogic(v, "B6");
      },
      fromBase7: function (v) {
        return NumericBaseLogic(v, "B7");
      },
      fromBase9: function (v) {
        return NumericBaseLogic(v, "B9");
      },
      fromBinary: function (v) {
        return NumericBaseLogic(v, "B2");
      },
      fromDecimal: function (v) {
        return NumericBaseLogic(v, "B10");
      },
      fromHexadecimal: function (v) {
        return NumericBaseLogic(v, "B16");
      },
      fromOctal: function (v) {
        return NumericBaseLogic(v, "B8");
      },
    },
    Pressure: {
      fromAttopascals: function (v) {
        return PressureLogic(v, "APA");
      },
      fromBars: function (v) {
        return PressureLogic(v, "BAR");
      },
      fromBaryes: function (v) {
        return PressureLogic(v, "BA");
      },
      fromCentimetersOfMercury0C: function (v) {
        return PressureLogic(v, "CMHG");
      },
      fromCentimetersOfWater4C: function (v) {
        return PressureLogic(v, "CMW4");
      },
      fromCentipascals: function (v) {
        return PressureLogic(v, "CPA");
      },
      fromDecibars: function (v) {
        return PressureLogic(v, "DBAR");
      },
      fromDecipascals: function (v) {
        return PressureLogic(v, "DPA");
      },
      fromDekapascals: function (v) {
        return PressureLogic(v, "DAPA");
      },
      fromDynesPerSquareCentimeter: function (v) {
        return PressureLogic(v, "DYNCM");
      },
      fromExapascals: function (v) {
        return PressureLogic(v, "EPA");
      },
      fromFeetOfSeaWater: function (v) {
        return PressureLogic(v, "FSW");
      },
      fromFeetOfWater4C: function (v) {
        return PressureLogic(v, "FTW4");
      },
      fromFeetOfWater60F: function (v) {
        return PressureLogic(v, "FTW60");
      },
      fromFemtopascals: function (v) {
        return PressureLogic(v, "FPA");
      },
      fromGigapascals: function (v) {
        return PressureLogic(v, "GPA");
      },
      fromGramsPerSquareCentimeter: function (v) {
        return PressureLogic(v, "GFCM");
      },
      fromHectopascals: function (v) {
        return PressureLogic(v, "HPA");
      },
      fromInchesOfMercury32F: function (v) {
        return PressureLogic(v, "INHG32");
      },
      fromInchesOfMercury60F: function (v) {
        return PressureLogic(v, "INHG60");
      },
      fromInchesOfWater4C: function (v) {
        return PressureLogic(v, "INW4");
      },
      fromInchesOfWater60F: function (v) {
        return PressureLogic(v, "INW60");
      },
      fromKSI: function (v) {
        return PressureLogic(v, "KSI");
      },
      fromKilogramsPerSquareCentimeter: function (v) {
        return PressureLogic(v, "KGFCM");
      },
      fromKilogramsPerSquareMeter: function (v) {
        return PressureLogic(v, "KGFM");
      },
      fromKilogramsPerSquareMillimeter: function (v) {
        return PressureLogic(v, "KFGMM");
      },
      fromKilonewtonsPerSquareMeter: function (v) {
        return PressureLogic(v, "KNM");
      },
      fromKilopascals: function (v) {
        return PressureLogic(v, "KPA");
      },
      fromKipsPerSquareInch: function (v) {
        return PressureLogic(v, "KIPFIN");
      },
      fromLongTonsPerSquareFoot: function (v) {
        return PressureLogic(v, "TFFTL");
      },
      fromLongTonsPerSquareInch: function (v) {
        return PressureLogic(v, "TFINL");
      },
      fromMegapascals: function (v) {
        return PressureLogic(v, "MPA");
      },
      fromMetersOfSeaWater: function (v) {
        return PressureLogic(v, "MSW");
      },
      fromMetersOfWater4C: function (v) {
        return PressureLogic(v, "MW4");
      },
      fromMicrobars: function (v) {
        return PressureLogic(v, "MUBAR");
      },
      fromMicropascals: function (v) {
        return PressureLogic(v, "MUPA");
      },
      fromMillibars: function (v) {
        return PressureLogic(v, "MILBAR");
      },
      fromMillimetersOfMercury0C: function (v) {
        return PressureLogic(v, "MMHG");
      },
      fromMillimetersOfWater4C: function (v) {
        return PressureLogic(v, "MMW4");
      },
      fromMillipascals: function (v) {
        return PressureLogic(v, "MILPA");
      },
      fromNanopascals: function (v) {
        return PressureLogic(v, "NPA");
      },
      fromNewtonsPerSquareCentimeter: function (v) {
        return PressureLogic(v, "NCM");
      },
      fromNewtonsPerSquareMeter: function (v) {
        return PressureLogic(v, "NM");
      },
      fromNewtonsPerSquareMillimeter: function (v) {
        return PressureLogic(v, "NMM");
      },
      fromPSI: function (v) {
        return PressureLogic(v, "PSI");
      },
      fromPascals: function (v) {
        return PressureLogic(v, "PA");
      },
      fromPetapascals: function (v) {
        return PressureLogic(v, "PEPA");
      },
      fromPicopascals: function (v) {
        return PressureLogic(v, "PPA");
      },
      fromPieze: function (v) {
        return PressureLogic(v, "PIZ");
      },
      fromPoundalsPerSquareFoot: function (v) {
        return PressureLogic(v, "PDLFT");
      },
      fromPoundsPerSquareFoot: function (v) {
        return PressureLogic(v, "LBFFT");
      },
      fromPoundsPerSquareInch: function (v) {
        return PressureLogic(v, "LBFIN");
      },
      fromShortTonsPerSquareFoot: function (v) {
        return PressureLogic(v, "TFFTS");
      },
      fromShortTonsPerSquareInch: function (v) {
        return PressureLogic(v, "TFINS");
      },
      fromStandardAtmospheres: function (v) {
        return PressureLogic(v, "ATM");
      },
      fromSthenesPerSquareMeter: function (v) {
        return PressureLogic(v, "SM");
      },
      fromTechnicalAtmospheres: function (v) {
        return PressureLogic(v, "AT");
      },
      fromTerapascals: function (v) {
        return PressureLogic(v, "TPA");
      },
      fromTorrs: function (v) {
        return PressureLogic(v, "TORR");
      },
    },
    Speed: {
      fromCentimetersPerHour: function (v) {
        return SpeedLogic(v, "CMH");
      },
      fromCentimetersPerMinute: function (v) {
        return SpeedLogic(v, "CMM");
      },
      fromCentimetersPerSecond: function (v) {
        return SpeedLogic(v, "CMS");
      },
      fromEarthsVelocity: function (v) {
        return SpeedLogic(v, "EV");
      },
      fromFeetPerHour: function (v) {
        return SpeedLogic(v, "FTH");
      },
      fromFeetPerMinute: function (v) {
        return SpeedLogic(v, "FTM");
      },
      fromFeetPerSecond: function (v) {
        return SpeedLogic(v, "FTS");
      },
      fromFirstCosmicVelocity: function (v) {
        return SpeedLogic(v, "CV1");
      },
      fromInchesPerHour: function (v) {
        return SpeedLogic(v, "INH");
      },
      fromInchesPerMinute: function (v) {
        return SpeedLogic(v, "INM");
      },
      fromInchesPerSecond: function (v) {
        return SpeedLogic(v, "INS");
      },
      fromKilometersPerHour: function (v) {
        return SpeedLogic(v, "KMH");
      },
      fromKilometersPerMinute: function (v) {
        return SpeedLogic(v, "KMM");
      },
      fromKilometersPerSecond: function (v) {
        return SpeedLogic(v, "KMS");
      },
      fromKnots: function (v) {
        return SpeedLogic(v, "KN");
      },
      fromLight: function (v) {
        return SpeedLogic(v, "C");
      },
      fromMach: function (v) {
        return SpeedLogic(v, "MA");
      },
      fromMetersPerHour: function (v) {
        return SpeedLogic(v, "MH");
      },
      fromMetersPerMinute: function (v) {
        return SpeedLogic(v, "MM");
      },
      fromMetersPerSecond: function (v) {
        return SpeedLogic(v, "MS");
      },
      fromMilesPerHour: function (v) {
        return SpeedLogic(v, "MIH");
      },
      fromMilesPerMinute: function (v) {
        return SpeedLogic(v, "MIM");
      },
      fromMilesPerSecond: function (v) {
        return SpeedLogic(v, "MIS");
      },
      fromMillimetersPerHour: function (v) {
        return SpeedLogic(v, "MMH");
      },
      fromMillimetersPerMinute: function (v) {
        return SpeedLogic(v, "MMM");
      },
      fromMillimetersPerSecond: function (v) {
        return SpeedLogic(v, "MMS");
      },
      fromSecondCosmicVelocity: function (v) {
        return SpeedLogic(v, "CV2");
      },
      fromSoundsInAir: function (v) {
        return SpeedLogic(v, "SA");
      },
      fromSoundsInWater: function (v) {
        return SpeedLogic(v, "SW");
      },
      fromThirdCosmicVelocity: function (v) {
        return SpeedLogic(v, "CV3");
      },
      fromYardsPerHour: function (v) {
        return SpeedLogic(v, "YH");
      },
      fromYardsPerMinute: function (v) {
        return SpeedLogic(v, "YM");
      },
      fromYardsPerSecond: function (v) {
        return SpeedLogic(v, "YS");
      },
    },
    Temperature: {
      fromCelsius: function (v) {
        return TemperatureLogic(v, "C");
      },
      fromFahrenheit: function (v) {
        return TemperatureLogic(v, "F");
      },
      fromKelvin: function (v) {
        return TemperatureLogic(v, "K");
      },
      fromRankine: function (v) {
        return TemperatureLogic(v, "R");
      },
      fromReaumur: function (v) {
        return TemperatureLogic(v, "RE");
      },
    },
    Time: {
      fromAttoseconds: function (v) {
        return TimeLogic(v, "AS");
      },
      fromCenturies: function (v) {
        return TimeLogic(v, "C");
      },
      fromDays: function (v) {
        return TimeLogic(v, "D");
      },
      fromDecades: function (v) {
        return TimeLogic(v, "DE");
      },
      fromFemtoseconds: function (v) {
        return TimeLogic(v, "FS");
      },
      fromFortnights: function (v) {
        return TimeLogic(v, "FN");
      },
      fromGregorianYears: function (v) {
        return TimeLogic(v, "GY");
      },
      fromHours: function (v) {
        return TimeLogic(v, "H");
      },
      fromJulianYears: function (v) {
        return TimeLogic(v, "JY");
      },
      fromLeapYears: function (v) {
        return TimeLogic(v, "LY");
      },
      fromMicroseconds: function (v) {
        return TimeLogic(v, "MUS");
      },
      fromMillenniums: function (v) {
        return TimeLogic(v, "M");
      },
      fromMilliseconds: function (v) {
        return TimeLogic(v, "MS");
      },
      fromMinutes: function (v) {
        return TimeLogic(v, "MIN");
      },
      fromMonths: function (v) {
        return TimeLogic(v, "MON");
      },
      fromNanoseconds: function (v) {
        return TimeLogic(v, "NS");
      },
      fromPicoseconds: function (v) {
        return TimeLogic(v, "PS");
      },
      fromSeconds: function (v) {
        return TimeLogic(v, "S");
      },
      fromWeeks: function (v) {
        return TimeLogic(v, "WK");
      },
      fromYears: function (v) {
        return TimeLogic(v, "Y");
      },
    },
    Torque: {
      fromDyneCentimeters: function (v) {
        return TorqueLogic(v, "DYNCM");
      },
      fromDyneMeters: function (v) {
        return TorqueLogic(v, "DYNM");
      },
      fromDyneMillimeters: function (v) {
        return TorqueLogic(v, "DYNMM");
      },
      fromGramCentimeters: function (v) {
        return TorqueLogic(v, "GFCM");
      },
      fromGramMeters: function (v) {
        return TorqueLogic(v, "GFM");
      },
      fromGramMillimeters: function (v) {
        return TorqueLogic(v, "GFMM");
      },
      fromKilogramCentimeters: function (v) {
        return TorqueLogic(v, "KGFCM");
      },
      fromKilogramMeters: function (v) {
        return TorqueLogic(v, "KGFM");
      },
      fromKilogramMillimeters: function (v) {
        return TorqueLogic(v, "KGFMM");
      },
      fromKilonewtonMeters: function (v) {
        return TorqueLogic(v, "KNM");
      },
      fromNewtonCentimeters: function (v) {
        return TorqueLogic(v, "NCM");
      },
      fromNewtonMeters: function (v) {
        return TorqueLogic(v, "NM");
      },
      fromNewtonMillimeters: function (v) {
        return TorqueLogic(v, "NMM");
      },
      fromOunceFeet: function (v) {
        return TorqueLogic(v, "OZFFT");
      },
      fromOunceInches: function (v) {
        return TorqueLogic(v, "OZFIN");
      },
      fromPoundFeet: function (v) {
        return TorqueLogic(v, "LBFFT");
      },
      fromPoundInches: function (v) {
        return TorqueLogic(v, "LBFIN");
      },
    },
    Volume: {
      fromAcreFeetUSSurvey: function (v) {
        return VolumeLogic(v, "ACFTUS");
      },
      fromAcreInches: function (v) {
        return VolumeLogic(v, "ACIN");
      },
      fromArceFeet: function (v) {
        return VolumeLogic(v, "ACFTO");
      },
      fromAttoliters: function (v) {
        return VolumeLogic(v, "AL");
      },
      fromBarrelsOfOil: function (v) {
        return VolumeLogic(v, "BBLO");
      },
      fromBarrelsUK: function (v) {
        return VolumeLogic(v, "BBLUK");
      },
      fromBarrelsUS: function (v) {
        return VolumeLogic(v, "BBLUS");
      },
      fromBoardFeet: function (v) {
        return VolumeLogic(v, "FBM");
      },
      fromCentiliters: function (v) {
        return VolumeLogic(v, "CL");
      },
      fromCords: function (v) {
        return VolumeLogic(v, "CORD");
      },
      fromCubicCentimeters: function (v) {
        return VolumeLogic(v, "CM");
      },
      fromCubicDecimeters: function (v) {
        return VolumeLogic(v, "DM");
      },
      fromCubicFeet: function (v) {
        return VolumeLogic(v, "FT");
      },
      fromCubicInches: function (v) {
        return VolumeLogic(v, "IN");
      },
      fromCubicKilometers: function (v) {
        return VolumeLogic(v, "KM");
      },
      fromCubicMeters: function (v) {
        return VolumeLogic(v, "M");
      },
      fromCubicMiles: function (v) {
        return VolumeLogic(v, "MI");
      },
      fromCubicMillimeters: function (v) {
        return VolumeLogic(v, "MM");
      },
      fromCubicYards: function (v) {
        return VolumeLogic(v, "YD");
      },
      fromCupsMetric: function (v) {
        return VolumeLogic(v, "CUPM");
      },
      fromCupsUK: function (v) {
        return VolumeLogic(v, "CUPUK");
      },
      fromCupsUS: function (v) {
        return VolumeLogic(v, "CUPUS");
      },
      fromDeciliters: function (v) {
        return VolumeLogic(v, "DL");
      },
      fromDecisteres: function (v) {
        return VolumeLogic(v, "DECI");
      },
      fromDekaliters: function (v) {
        return VolumeLogic(v, "DAL");
      },
      fromDekasteres: function (v) {
        return VolumeLogic(v, "DEKA");
      },
      fromDessertspoonsUK: function (v) {
        return VolumeLogic(v, "DSTSPNUK");
      },
      fromDessertspoonsUS: function (v) {
        return VolumeLogic(v, "DSTSPNUS");
      },
      fromDrops: function (v) {
        return VolumeLogic(v, "DROP");
      },
      fromExaliters: function (v) {
        return VolumeLogic(v, "EL");
      },
      fromFemtoliters: function (v) {
        return VolumeLogic(v, "FL");
      },
      fromFluidOuncesUK: function (v) {
        return VolumeLogic(v, "FLOZUK");
      },
      fromFluidOuncesUS: function (v) {
        return VolumeLogic(v, "FLOZUS");
      },
      fromGallonsUK: function (v) {
        return VolumeLogic(v, "GALUK");
      },
      fromGallonsUS: function (v) {
        return VolumeLogic(v, "GALUS");
      },
      fromGigaliters: function (v) {
        return VolumeLogic(v, "GL");
      },
      fromGillsUK: function (v) {
        return VolumeLogic(v, "GILUK");
      },
      fromGillsUS: function (v) {
        return VolumeLogic(v, "GILUS");
      },
      fromHectoliters: function (v) {
        return VolumeLogic(v, "HL");
      },
      fromHogsheads: function (v) {
        return VolumeLogic(v, "HOG");
      },
      fromHundredCubicFeet: function (v) {
        return VolumeLogic(v, "CCF");
      },
      fromKiloliters: function (v) {
        return VolumeLogic(v, "KL");
      },
      fromLiters: function (v) {
        return VolumeLogic(v, "L");
      },
      fromMegaliters: function (v) {
        return VolumeLogic(v, "ML");
      },
      fromMicroliters: function (v) {
        return VolumeLogic(v, "MUL");
      },
      fromMilliliters: function (v) {
        return VolumeLogic(v, "MILL");
      },
      fromMinimsUK: function (v) {
        return VolumeLogic(v, "MINIUK");
      },
      fromMinimsUS: function (v) {
        return VolumeLogic(v, "MINIUS");
      },
      fromNanoliters: function (v) {
        return VolumeLogic(v, "NL");
      },
      fromPetaliters: function (v) {
        return VolumeLogic(v, "PEL");
      },
      fromPicoliters: function (v) {
        return VolumeLogic(v, "PL");
      },
      fromPintsUK: function (v) {
        return VolumeLogic(v, "PTUK");
      },
      fromPintsUS: function (v) {
        return VolumeLogic(v, "PTUS");
      },
      fromQuartsUK: function (v) {
        return VolumeLogic(v, "QTUK");
      },
      fromQuartsUS: function (v) {
        return VolumeLogic(v, "QTUS");
      },
      fromRegisterTons: function (v) {
        return VolumeLogic(v, "REGTON");
      },
      fromSteres: function (v) {
        return VolumeLogic(v, "ST");
      },
      fromTablespoonsMetric: function (v) {
        return VolumeLogic(v, "TBSPM");
      },
      fromTablespoonsUK: function (v) {
        return VolumeLogic(v, "TBSPUK");
      },
      fromTablespoonsUS: function (v) {
        return VolumeLogic(v, "TBSPUS");
      },
      fromTeaspoonsMetric: function (v) {
        return VolumeLogic(v, "TSPM");
      },
      fromTeaspoonsUK: function (v) {
        return VolumeLogic(v, "TSPUK");
      },
      fromTeaspoonsUS: function (v) {
        return VolumeLogic(v, "TSPUS");
      },
      fromTeraliters: function (v) {
        return VolumeLogic(v, "TL");
      },
      fromTuns: function (v) {
        return VolumeLogic(v, "TUN");
      },
    },
  };
})();
