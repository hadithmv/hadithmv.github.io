(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["mergely"] = factory();
  else root["mergely"] = factory();
})(self, () => {
  return /******/ (() => {
    // webpackBootstrap
      ...
      /***/ 653: /***/ (
        ...
        (function (mod) {
          ...
          function searchRegexpBackwardMultiline(doc, regexp, start) {
            ...
            for (
              var line = start.line, first = doc.firstLine();
              line >= first;
          ...
          SearchCursor.prototype = {
            ...
            find: function (reverse) {
              var head = this.doc.clipPos(
                reverse ? this.pos.from : this.pos.to
              );
      ...
      /***/ 237: /***/ function (module) {
        ...
        (function (global, factory) {
          ...
          function hasBadZoomedRects(measure) {
            ...
            return (badZoomedRects =
              Math.abs(normal.left - fromRange.left) > 1);
          }
          ...
          function interpretTokenStyle(style, options) {
            ...
            var cache = options.addModeClass
              ...
              : styleToClassCache;
            return (
              cache[style] || (cache[style] = style.replace(/\S+/g, "cm-$&"))
            );
          }
          ...
          function buildToken(
            ...
            builder.trailingSpace =
              displayText.charCodeAt(text.length - 1) == 32;
            if (
              style ||
              startStyle ||
              endStyle ||
          ...
          function intoCoordSystem(cm, lineObj, rect, context, includeWidgets) {
            ...
            if (context == "page" || context == "window") {
              ...
              yOff +=
                lOff.top + (context == "window" ? 0 : pageScrollY(doc(cm)));
              var xOff =
          ...
          function getDimensions(cm) {
            ...
            for (
              var n = d.gutters.firstChild, i = 0;
              n;
              n = n.nextSibling, ++i
            ) {
          ...
          function prepareSelection(cm, primary) {
            ...
            var doc = cm.doc,
              result = {};
            var curFragment = (result.cursors =
          ...
          function drawSelectionCursor(cm, head, output) {
            ...
            cursor.style.height =
              Math.max(0, pos.bottom - pos.top) * cm.options.cursorHeight +
              "px";
          ...
          function scrollPosIntoView(cm, pos, end, margin) {
            ...
            for (var limit = 0; limit < 5; limit++) {
              ...
              var endCoords =
                !end || end == pos ? coords : cursorCoords(cm, end);
              rect = {
          ...
          function History(prev) {
            ...
            this.generation = this.maxGeneration = prev
              ? prev.maxGeneration
              : 1;
          }
          ...
          function onDragStart(cm, e) {
            if (
              ie &&
              (!cm.state.draggingText || +new Date() - lastDrop < 100)
            ) {
              e_stop(e);
              return;
            }
          ...
          function isModifierKey(value) {
            var name =
              typeof value == "string" ? value : keyNames[value.keyCode];
            return (
              name == "Ctrl" ||
              name == "Alt" ||
              name == "Shift" ||
                ...
                for (var i = 0; i < ranges.length; i++) {
                  ...
                  if (!range.empty()) {
                    ...
                    var start = Math.max(end, from.line);
                      ...
                      Math.min(this.lastLine(), to.line - (to.ch ? 0 : 1)) + 1;
          ...
          function posToDOM(cm, pos) {
            ...
            result.offset =
              result.collapse == "right" ? result.end : result.start;
            return result;
          }
          ...
          TextareaInput.prototype.init = function (display) {
            ...
            display.wrapper.insertBefore(
              this.wrapper,
              display.wrapper.firstChild
            );
...
*/
      ...
      /***/ 875: /***/ (
        ...
        /* harmony import */ var _css_loader_dist_cjs_js_codemirror_css__WEBPACK_IMPORTED_MODULE_6__ =
        ...
        var update =
          _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(
            _css_loader_dist_cjs_js_codemirror_css__WEBPACK_IMPORTED_MODULE_6__ /* ["default"] */.A,
            options
          );

        /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
          _css_loader_dist_cjs_js_codemirror_css__WEBPACK_IMPORTED_MODULE_6__ /* ["default"] */.A &&
          _css_loader_dist_cjs_js_codemirror_css__WEBPACK_IMPORTED_MODULE_6__ /* ["default"] */
            .A.locals
            ? _css_loader_dist_cjs_js_codemirror_css__WEBPACK_IMPORTED_MODULE_6__ /* ["default"] */
                .A.locals
            : undefined;
      ...
      /***/ 143: /***/ (
        ...
        /* harmony import */ var _node_modules_worker_loader_dist_runtime_inline_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(512);
        /* harmony import */ var _node_modules_worker_loader_dist_runtime_inline_js__WEBPACK_IMPORTED_MODULE_0___default =
          /*#__PURE__*/ __webpack_require__.n(
        ...
        module.exports = function (
          ...
          try {
            try {
              ...
              var worker = new globalScope[workerConstructor](
                objectURL,
                workerOptions
              );
      ...
      /***/ 819: /***/ (
        ...
        CodeMirrorDiffView.prototype.scrollToDiff = function (direction) {
          ...
          if (direction === "next") {
            ...
            if (this._current_diff == 0 || this._current_diff === undefined) {
              this._current_diff = this.changes.length - 1;
            } else {
        ...
        CodeMirrorDiffView.prototype.setOptions = function (opts) {
          const current_margin_rhs = this.settings
            ? this.settings.rhs_margin
            : "right";
          this.settings = {
            ...this.settings,
            ...opts,
          ...
          if (this.editor) {
            ...
            if (
              opts.hasOwnProperty("rhs_margin") &&
              opts.rhs_margin !== current_margin_rhs
            ) {
              // dynamically swap the margin
              const divs = document.querySelectorAll(
                `#${this.id} .mergely-editor > div`
              );
        ...
        CodeMirrorDiffView.prototype.search = function (
          side,
          query,
          direction
        ) {
          ...
          const searchDirection =
            direction === "prev" ? "findPrevious" : "findNext";
          ...
          if (cursor[searchDirection]()) {
            ...
            cursor = this.cursor[this.id] = editor.getSearchCursor(
              query,
              start,
              false
            );
            ...
            for (let i = 0; i < this.changes.length; ++i) {
              ...
              if (line >= lf && line <= lt) {
                ...
                if (this._current_diff >= 0) {
                  ...
                  for (
                    let i = current["lhs-line-from"];
                    i <= current["lhs-line-to"];
                    ++i
                  ) {
                    this.editor.lhs.removeLineClass(i, "gutter");
                  }
                  for (
                    let i = current["rhs-line-from"];
                    i <= current["rhs-line-to"];
                    ++i
                  ) {
        ...
        CodeMirrorDiffView.prototype._scroll_to_change = function (change) {
          ...
          const { lhs: led, rhs: red } = this.editor;
          // set cursors
          ...
          for (const change of this.changes) {
            if (midline.line >= change[side + "-line-from"]) {
              ...
              if (midline.line >= last_change[side + "-line-to"]) {
                if (
                  !change.hasOwnProperty(side + "-y-start") ||
        ...
        CodeMirrorDiffView.prototype._isChangeInView = function (
          side,
          vp,
          change
        ) {
          if (
            change[`${side}-line-from`] < 0 ||
            change[`${side}-line-to`] < 0
          ) {
          ...
          return (
            (change[`${side}-line-from`] >= vp.from &&
              change[`${side}-line-from`] <= vp.to) ||
            (change[`${side}-line-to`] >= vp.from &&
              change[`${side}-line-to`] <= vp.to) ||
            (vp.from >= change[`${side}-line-from`] &&
              vp.to <= change[`${side}-line-to`])
          );
        };
        ...
        CodeMirrorDiffView.prototype._calculateOffsets = function (changes) {
          ...
          this.draw_mid_width = this._queryElement(
            `#${this.id}-lhs-rhs-canvas`
          ).offsetWidth;
          ...
          const mode = "local";
          const lineWrapping =
            led.getOption("lineWrapping") || red.getOption("lineWrapping");
          const lhschc = !lineWrapping
            ? led.charCoords({ line: 0 }, mode)
            : null;
          const rhschc = !lineWrapping
            ? red.charCoords({ line: 0 }, mode)
            : null;
          ...
          for (const change of changes) {
            const llf =
              change["lhs-line-from"] >= 0 ? change["lhs-line-from"] : 0;
            const llt = change["lhs-line-to"] >= 0 ? change["lhs-line-to"] : 0;
            const rlf =
              change["rhs-line-from"] >= 0 ? change["rhs-line-from"] : 0;
        ...
        CodeMirrorDiffView.prototype._markupLineChanges = function (changes) {
          ...
          for (let i = 0; i < changes.length; ++i) {
            ...
            if (lhsInView) {
              const osideEditable =
                this.settings.line_numbers && !red.getOption("readOnly");
              ...
              vdoc.addRender("lhs", change, i, {
                ...
                mergeButton: osideEditable
                  ? this.merge_rhs_button.cloneNode(true)
                  : null,
              });
            }
            ...
            if (rhsInView) {
              const osideEditable =
                this.settings.line_numbers && !led.getOption("readOnly");
              ...
              vdoc.addRender("rhs", change, i, {
                ...
                mergeButton: osideEditable
                  ? this.merge_lhs_button.cloneNode(true)
                  : null,
              });
            }

            if (lineDiff && (lhsInView || rhsInView) && change.op === "c") {
        ...
        CodeMirrorDiffView.prototype._merge_change = function (
          change,
          side,
          oside
        ) {
          ...
          if (change.op === "c") {
            text = doc.getRange(
              ...
              CodeMirror.Pos(to, tolen)
            );
            odoc.replaceRange(
              text,
              CodeMirror.Pos(ofrom, 0),
              CodeMirror.Pos(oto, otolen)
            );
          } else if (
            (oside === "lhs" && change.op === "d") ||
            (oside === "rhs" && change.op === "a")
          ) {
            if (from > 0) {
              text = doc.getRange(
                CodeMirror.Pos(from, fromlen),
                CodeMirror.Pos(to, tolen)
              );
              ofrom += 1;
            } else {
              text = doc.getRange(
                CodeMirror.Pos(0, 0),
                CodeMirror.Pos(to + 1, 0)
              );
            }
            odoc.replaceRange(
              text,
              CodeMirror.Pos(ofrom - 1, 0),
              CodeMirror.Pos(oto + 1, 0)
            );
          } else if (
            (oside === "rhs" && change.op === "d") ||
            (oside === "lhs" && change.op === "a")
          ) {
            if (from > 0) {
              fromlen = doc.getLine(from - 1).length + 1;
              text = doc.getRange(
                CodeMirror.Pos(from - 1, fromlen),
                CodeMirror.Pos(to, tolen)
              );
            } else {
              text = doc.getRange(
        ...
        CodeMirrorDiffView.prototype._renderDiff = function (changes) {
          ...
          this.trace(
            "draw#_renderDiff",
            "visible page height",
            ex.visible_page_height
          );
          this.trace(
            "draw#_renderDiff",
            "scroller-top lhs",
            ex.lhs_scroller.scrollTop
          );
          this.trace(
            "draw#_renderDiff",
            "scroller-top rhs",
            ex.rhs_scroller.scrollTop
          );

          ex.lhs_margin.removeEventListener(
            "click",
            this._handleLhsMarginClick
          );
          ex.rhs_margin.removeEventListener(
            "click",
            this._handleRhsMarginClick
          );
          ...
          const lratio =
            ex.lhs_margin.offsetHeight / ex.lhs_scroller.scrollHeight;
          const rratio =
            ex.rhs_margin.offsetHeight / ex.rhs_scroller.scrollHeight;
          ...
          for (let i = 0; i < changes.length; ++i) {
            ...
            ctx_lhs.fillRect(
              ...
              mkr_lhs_y_start,
              4.5,
              Math.max(mkr_lhs_y_end - mkr_lhs_y_start, 5)
            );
            ctx_lhs.strokeRect(
              1.5,
              mkr_lhs_y_start,
            ...
            ctx_rhs.fillRect(
              ...
              mkr_rhs_y_start,
              4.5,
              Math.max(mkr_rhs_y_end - mkr_rhs_y_start, 5)
            );
            ctx_rhs.strokeRect(
              1.5,
              mkr_rhs_y_start,
            ...
            if (
              !this._isChangeInView("lhs", lhsvp, change) &&
            ...
            const borderColor =
              this._current_diff === i
                ? this.settings._colors.current.border
                : this.settings._colors[change.op].border;
          ...
          this._handleLhsMarginClick = function (ev) {
            ...
            const sto = Math.max(
              0,
              (y / mcanvas_lhs.height) * ex.lhs_scroller.scrollHeight
            );
          ...
          this._handleRhsMarginClick = function (ev) {
            ...
            const sto = Math.max(
              0,
              (y / mcanvas_rhs.height) * ex.rhs_scroller.scrollHeight
            );
      ...
      /***/ 369: /***/ (module) => {
        ...
        function diff(lhs, rhs, options = {}) {
          ...
          this._lcs(
            lhs_ctx,
            0,
            lhs_ctx.codes.length,
            rhs_ctx,
            0,
            rhs_ctx.codes.length,
            vector_u,
            vector_d
          );
          this._optimize(lhs_ctx);
        ...
        diff.prototype.normal_form = function () {
          ...
          for (let index = 0; index < this.items.length; ++index) {
            ...
            if (item.lhs_deleted_count === 0 && item.rhs_inserted_count > 0)
              ...
              item.lhs_deleted_count > 0 &&
              item.rhs_inserted_count === 0
            )
              change = "d";
            ...
            if (item.lhs_deleted_count === 1) lhs_str = item.lhs_start + 1;
              ...
              lhs_str =
                ...
                1 +
                "," +
                (item.lhs_start + item.lhs_deleted_count);
            ...
            if (item.rhs_inserted_count === 1) rhs_str = item.rhs_start + 1;
              ...
              rhs_str =
                ...
                1 +
                "," +
                (item.rhs_start + item.rhs_inserted_count);
            nf += lhs_str + change + rhs_str + "\n";
            ...
            if (rhs_lines && lhs_lines) {
              ...
              for (
                i = item.lhs_start;
                i < item.lhs_start + item.lhs_deleted_count;
                ++i
              ) {
                nf += "< " + lhs_lines[i] + "\n";
              }
              ...
              for (
                i = item.rhs_start;
                i < item.rhs_start + item.rhs_inserted_count;
                ++i
              ) {
                nf += "> " + rhs_lines[i] + "\n";
              }
        ...
        diff.prototype._optimize = function (ctx) {
          ...
          while (start < ctx.codes.length) {
            while (
              start < ctx.codes.length &&
              (ctx.modified[start] === undefined ||
                ctx.modified[start] === false)
            ) {
              start++;
            }
        ...
        class Mergely {
          constructor(selector, options) {
            ...
            if (typeof selector === "string") {
              ...
              throw new Error(
                `The 'selector' element must be a string or DOM element`
              );
            }
          ...
          summary() {
            ...
            return {
              ...
              c: this._changes.filter(function (a) {
                return a.op === "c";
              }).length,
              a: this._changes.filter(function (a) {
                return a.op === "a";
              }).length,
              d: this._changes.filter(function (a) {
                return a.op === "d";
              }).length,
            };
          }
      ...
      /***/ 622: /***/ (
        ...
        class VDoc {
          ...
          addRender(side, change, changeId, options) {
            ...
            const { isCurrent, lineDiff, mergeButton, getMergeHandler } =
              options;
            ...
            if (alreadyRendered) {
              if (this.options._debug) {
                trace(
                  "vdoc#addRender (already rendered)",
                  side,
                  changeId,
                  change
                );
            ...
            if (isCurrent) {
              ...
              for (let j = lf; j <= lt; ++j) {
                this._getLine(side, j).addLineClass(
                  "gutter",
                  "mergely current"
                );
              }
            ...
            if (lf < 0) {
              ...
              this._getLine(side, 0).addLineClass(
                "background",
                bgClass.join(" ")
              );
            ...
            if (
              ...
              bgClass.push("end");
              bgClass.push(bgChangeOp);
              this._getLine(side, lf).addLineClass(
                "background",
                bgClass.join(" ")
              );
              this._setRenderedChange(side, changeId);
            ...
            for (
              ...
              if (side === "lhs" && change.op === "d") {
                ...
                this._getLine(side, j).markText(
                  0,
                  undefined,
                  `mergely ch d lhs cid-${changeId}`
                );
            ...
            if (mergeButton) {
              ...
              this._getLine(side, lf).addMergeButton(
                "merge",
                mergeButton,
                handler
              );
          ...
          addInlineDiff(
            change,
            changeId,
            { getText, ignorews, ignoreaccents, ignorecase }
          ) {
            if (this.options._debug) {
              ...
              if (j <= lt && k <= olt) {
                ...
                for (const change of results.changes()) {
                  ...
                  lhs_line.markText(
                    lhs_start,
                    lhs_to,
                    `mergely ch ind lhs cid-${changeId}`
                  );
                  const rhs_line = vdoc._getLine("rhs", k);
                  rhs_line.markText(
                    rhs_start,
                    rhs_to,
                    `mergely ch ina rhs cid-${changeId}`
                  );
                }
              } else if (k > olt) {
