...
<!-- TOC --><a name="-project-aims"></a>

### 🎯 Project Aims

<!-- TOC --><a name="1-accessibility"></a>
...
<!-- TOC --><a name="3-community-building"></a>
...
<!-- TOC --><a name="-featured-books-of-hadith-and-athar"></a>
...
<!-- TOC --><a name="-featured-books-of-aqida-and-usooluddeen"></a>
...
<!-- TOC --><a name="-also-includes-the-following"></a>
...
<!-- TOC --><a name="i-dont-know-how-to-use-hadithmv-i-cant-copy-or-search-i-find-this-difficult-and-am-stuck"></a>
...
<!-- TOC --><a name="who-founded-hadithmv"></a>
...
<!-- TOC --><a name="how-is-hadithmv-written"></a>
...
<!-- TOC --><a name="i-have-a-suggestion-correction-question-how-can-i-contact-you"></a>

### I have a suggestion / correction / question. How can I contact you?

Simply reach out to us from the menu.

<!-- TOC --><a name="is-hadithmv-on-social-media-can-you-make-a-page-and-post-hadith"></a>
...
<!-- TOC --><a name="why-dont-you-add-a-clickable-tasbih-counter-to-hisnul-muslim"></a>
...
<!-- TOC --><a name="how-do-i-continue-reading-a-book-from-the-last-place-i-was-at-a-later-time"></a>
...
<!-- TOC --><a name="why-am-i-getting-a-warning-when-downloading-the-windows-app"></a>
...
<!-- TOC --><a name="is-there-an-ios-app"></a>
...
<!-- TOC --><a name="can-i-join-the-hadithmv-project"></a>
...
<!-- TOC --><a name="how-else-can-i-help-with-hadithmv"></a>
...
<!-- TOC --><a name="who-else-has-participated-in-the-hadithmv-project"></a>
...
<!-- TOC --><a name="why-is-it-called-hadithmv-and-why-are-there-other-than-hadith-in-it"></a>
...
<!-- TOC --><a name="why-is-hadithmv-not-all-in-dhivehi-why-is-there-english"></a>
...
<!-- TOC --><a name="what-platforms-websites-apps-software-and-tools-do-you-personally-use"></a>
...
<!-- TOC --><a name="what-exactly-is-the-all-hadith-and-athar-section"></a>
...
<!-- TOC --><a name="what-is-the-difference-between-the-hadithmv-quran-translation-and-bakurubes-quran-translation-which-is-also-on-hadithmv"></a>
...
<!-- TOC --><a name="theres-another-separate-bakurubeyge-tharujama-app-was-that-made-by-you"></a>
...
<!-- TOC --><a name="what-can-i-mainly-do-on-hadithmv"></a>
...
<!-- TOC --><a name="is-it-all-just-translations-what-else-is-there-on-hadithmv"></a>
...
<!-- TOC --><a name="what-is-the-fastest-way-to-write-"></a>
...
<!-- TOC --><a name="what-is-the-fastest-way-to-add-up-a-total-calculate-my-zakat"></a>
...
<!-- TOC --><a name="what-else-can-i-do-on-the-text-editor"></a>
...
<!-- TOC --><a name="i-messed-up-the-search-settings-on-hadithmv-how-do-i-reset-things"></a>
...
<!-- TOC --><a name="how-is-hadithmv-different"></a>
...
<!-- TOC --><a name="could-you-record-video-and-audio-to-go-with-the-hadith"></a>
...
<!-- TOC --><a name="how-does-hadithmv-make-content-at-this-pace"></a>
...
<!-- TOC --><a name="how-is-hadithmv-funded"></a>
...
<!-- TOC --><a name="are-the-translations-correct"></a>
...
<!-- TOC --><a name="do-you-have-any-advice-for-someone-who-would-like-to-do-their-own-translations"></a>
...
<!-- TOC --><a name="are-the-translations-approved-by-the-islamic-ministry"></a>
...
<!-- TOC --><a name="are-all-the-hadith-here-authentic"></a>
...
<!-- TOC --><a name="how-do-you-source-your-arabic-text"></a>
...
<!-- TOC --><a name="what-numbering-system-do-you-use-to-reference-hadith"></a>
...
<!-- TOC --><a name="when-i-looked-up-the-reference-number-from-a-source-why-did-it-not-match"></a>
...
<!-- TOC --><a name="is-it-okay-if-i-dont-reference-the-source-books-and-numbers-of-hadith-when-including-hadith-in-writings-of-my-own"></a>
...
<!-- TOC --><a name="what-fonts-does-hadithmv-use"></a>
...
<!-- TOC --><a name="for-the-arabic-quran-text-do-you-use-rasm-uthmani-or-imlaaee"></a>
...
<!-- TOC --><a name="why-is-the-site-different-from-the-app"></a>
...
<!-- TOC --><a name="why-is-a-translation-different-from-before"></a>
...
<!-- TOC --><a name="why-is-a-book-on-hadithmv-incomplete"></a>
...
<!-- TOC --><a name="could-i-know-more-about-a-particular-book"></a>
...
<!-- TOC --><a name="which-books-are-currently-available"></a>
...
<!-- TOC --><a name="which-books-will-be-available-soon"></a>
...
<!-- TOC --><a name="why-did-you-translate-muwatta-instead-of-this-and-that-book"></a>
...
<!-- TOC --><a name="when-will-you-translate-bukhari-and-muslim"></a>
...
<!-- TOC --><a name="do-these-texts-have-explanations-shurooh-or-english-translations"></a>
...
<!-- TOC --><a name="are-there-any-physical-books-i-can-get"></a>
...
<!-- TOC --><a name="can-you-pin-certain-posts-on-certain-social-media-to-make-it-easer-to-read-from-there"></a>
...
<!-- TOC --><a name="does-hadithmv-have-any-mirrors-in-case-the-main-site-is-down"></a>
...
<!-- TOC --><a name="will-you-continue-to-update-and-improve-hadithmv-both-in-content-and-design"></a>
...
<!-- TOC --><a name="what-will-happen-to-hadithmv-if-something-happens-to-you"></a>
...
<!-- TOC --><a name="what-is-your-belief-aqeedah-manhaj-and-usool"></a>
...
<!-- TOC --><a name="do-you-ascribe-to-any-particular-sect-group-party-ideology-philosophy"></a>

### Do you ascribe to any particular sect / group / party / ideology / philosophy?

Read the above. Again.

<!-- TOC --><a name="what-are-some-people-called-abuumm"></a>
...
<!-- TOC --><a name="how-and-when-did-you-start-hadithmv"></a>
...
<!-- TOC --><a name="has-the-hadithmv-logo-changed"></a>
...
<!-- TOC --><a name="how-about-using-more-fancier-images-icons-animations-transitions-colors-themes"></a>
...
<!-- TOC --><a name="can-i-use-the-texts-of-hadithmv-in-my-own-app-how-is-hadithmv-licensed-as-a-software"></a>
...
<!-- TOC --><a name="what-tools-was-hadithmv-made-with"></a>

### What tools was Hadithmv made with?

You can read about that [here](thirdPartyTools.html).

<!-- TOC --><a name="why-not-make-separate-apps-for-all-of-the-books"></a>
...
<!-- TOC --><a name="why-is-it-hadithmvgithubio-instead-of-hadithmvcom"></a>
...
<!-- TOC --><a name="whats-the-deal-with-thikijehi-thaana-dhivehi-diacritics"></a>
...
<!-- TOC --><a name="i-learned-about-a-hadith-can-i-issue-fatwa-and-solve-fiqh-disputes"></a>
...
<!-- TOC --><a name="what-is-the-most-important-thing"></a>
