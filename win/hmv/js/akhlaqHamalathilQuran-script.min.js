$(document).ready(() => {
  ...
  const c = $("#akhlaqHamalathilQuranTable").DataTable({
    data: akhlaqHamalathilQuran_DB,
    columns: [
      {
        data: 0,
        title: "#",
      ...
      { data: 3, title: "އަރަބި ފުޓްނޯޓު" },
      { data: 4, title: "ބާބު ދިވެހިން" },
      { data: 5, title: "ދިވެހި ތަރުޖަމާ" },
      { data: 6, title: "ދިވެހި ފުޓްނޯޓު" },
    ],
    columnDefs: [
      {
        targets: [4, 7],
    ...
    buttons: [
      {
        ...
        customize(a) {
          ...
          a = a.replace(/އަރަބި ފުޓްނޯޓު\t/g, "");
          a = a.replace(/ބާބު ދިވެހިން\t/g, "");
          a = a.replace(/ދިވެހި ތަރުޖަމާ\t/g, "");
          a = a.replace(/ދިވެހި ފުޓްނޯޓު\t/g, "");
