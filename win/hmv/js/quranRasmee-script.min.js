$(document).ready(() => {
  ...
  const h = (function (a, b) {
      return Array.from({ length: Math.max(a.length, b.length) }, (d, c) =>
        [].concat(
          Array.isArray(a[c]) ? a[c] : Array(b[c].length).fill(""),
          Array.isArray(b[c]) ? b[c] : Array(a[c].length).fill("")
        )
      );
    ...
    e = $("#quranTable").DataTable({
      ...
      columns: [
        ...
        { data: 5, title: "ތަރުޖަމާ އަރަބިއާއެކު" },
        { data: 6, title: "ތަރުޖަމާ ތާނައެކަނި" },
      ],
      columnDefs: [
        {
          className: "qCol1",
