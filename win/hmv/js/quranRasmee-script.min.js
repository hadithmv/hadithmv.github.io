  ...
  const h = (function (a, b) {
    ...
    e = $("#quranTable").DataTable({
      ...
      columns: [
        ...
        { data: 6, title: "ތަރުޖަމާ އަރަބިއާއެކު" },
        { data: 7, title: "ތަރުޖަމާ ތާނައެކަނި" },
      ],
      columnDefs: [
        {
          className: "qCol1",
      ...
      buttons: [
        {
          ...
          text: "ކޮޕީ",
          messageTop: "ރަސްމީ ޤުރްއާން ތަރުޖަމާ",
          title: "",
          customize(a) {
            a = a.replace(/\r\n|\n/g, "\t");
            ...
            a = a.replace(/ތަރުޖަމާ އަރަބިއާއެކު\t/g, "");
            a = a.replace(/ތަރުޖަމާ ތާނައެކަނި\t/g, "");
            a = a.replace(/\t\t/g, "\t");
            a = a.replace(/\n\n\n\n|\n\n\n|\t|\s\s/g, "\n\n");
            a = a.replace(
