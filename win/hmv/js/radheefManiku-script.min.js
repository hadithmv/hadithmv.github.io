$(document).ready(() => {
  ...
  const c = $("#radheefManikuTable").DataTable({
    data: radheefManiku_DB,
    columns: [
      { data: 1, title: "ދިވެހި ލަފްޒު" },
      { data: 0, title: "އިނގިރޭސިން ތާނަ" },
      { data: 2, title: "އިނގިރޭސިން ބާވަތް" },
      { data: 3, title: "އިނގިރޭސި މާނަ" },
    ],
    columnDefs: [
      {
        targets: "_all",
      ...
      { className: "colEng", targets: [1], visible: !0, searchable: !0 },
      { className: "colEng", targets: [2], visible: !0, searchable: !1 },
    ...
    buttons: [
      {
        ...
        text: "ކޮޕީ",
        messageTop:
          "A Concise Etymological Vocabulary of Dhivehi Language - Maniku ",
        title: "",
        customize(a) {
          a = a.replace(/\r\n|\n/g, "\t");
          ...
          a = a.replace(/ދިވެހި ލަފްޒު\t/g, "");
          a = a.replace(/އިނގިރޭސިން ބާވަތް\t/g, "");
