$(document).ready(() => {
  ...
  resultusooluSunnah = d(usooluSunnah_DB, [4, 5]);
  resultbarbahari = d(barbahari_DB, [1, 2, 3, 7, 8]);
  resultaqidatuRaziyain = d(aqidatuRaziyain_DB, [3]);
  resultkitabulEman = d(kitabulEman_DB, [3, 6, 7]);
  resultnawaqidulislam = d(nawaqidulislam_DB, [2, 6, 7, 8]);
  resultqawaidulArbau = d(qawaidulArbau_DB, [2, 6, 7, 8]);
  resultusooluSiththa = d(usooluSiththa_DB, [2, 6, 7, 8]);
  resultusooluThalaatha = d(usooluThalaatha_DB, [2, 6, 7, 8]);
  resultusooluSunnah = e(resultusooluSunnah, "أصول السنة لأحمد");
  resultbarbahari = e(resultbarbahari, "شرح السنة للبربهاري");
  resultaqidatuRaziyain = e(resultaqidatuRaziyain, "عقيدة الرازيين");
  resultkitabulEman = e(resultkitabulEman, "كتاب الإيمان لأبي عبيد");
  resultnawaqidulislam = e(resultnawaqidulislam, "نواقض الإسلام");
  resultqawaidulArbau = e(resultqawaidulArbau, "القواعد الأربع");
  resultusooluSiththa = e(resultusooluSiththa, "الأصول الستة");
  resultusooluThalaatha = e(resultusooluThalaatha, "الأصول الثلاثة");
  let m = [
