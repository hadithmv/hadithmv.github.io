$(document).ready(() => {
  ...
  const d = $("#radheefRasmeeTable").DataTable({
    data: radheefRasmee_DB,
    columns: [
      { data: 0, title: "ދިވެހި ލަފްޒު" },
      { data: 1, title: "އިނގިރޭސިން ތާނަ" },
      { data: 2, title: "އިނގިރޭސި މާނަ" },
      { data: 3, title: "ދިވެހި މާނަ" },
      {
        data: 4,
        title: "މައި ގިންތި",
    ...
    columnDefs: [
      { className: "radheefCol1", targets: [0], visible: !0, searchable: !0 },
      { className: "radheefCol2", targets: [1], visible: !0, searchable: !1 },
      { className: "colEng", targets: [2], visible: !0, searchable: !0 },
      { className: "radheefCol4", targets: [3], visible: !0, searchable: !0 },
      { className: "radheefCol5", targets: [4], visible: !0, searchable: !1 },
      { className: "radheefCol6", targets: [5], visible: !0, searchable: !1 },
      { className: "radheefCol7", targets: [6], visible: !0, searchable: !1 },
      { className: "radheefCol8", targets: [7], visible: !0, searchable: !1 },
      { className: "radheefCol9", targets: [8], visible: !0, searchable: !1 },
      { className: "radheefCol10", targets: [9], visible: !0, searchable: !1 },
      { className: "radheefCol11", targets: [10], visible: !0, searchable: !1 },
      { className: "radheefCol12", targets: [11], visible: !0, searchable: !0 },
      { className: "colEng", targets: [12], visible: !0, searchable: !1 },
      {
        targets: "all",
        render(a, b, c, g) {
          return "export" === b
    ...
    buttons: [
      {
        ...
        text: "ކޮޕީ",
        messageTop: "ދިވެހިބަހުގެ ރަދީފު",
        title: "",
        customize(a) {
          a = a.replace(/\r\n|\n/g, "\t");
          a = a.replace(/ދިވެހި ލަފްޒު\t/g, "");
          a = a.replace(/އިނގިރޭސިން ތާނަ\t/g, "");
          a = a.replace(/އިނގިރޭސި މާނަ\t/g, "");
          a = a.replace(/ދިވެހި މާނަ\t/g, "");
          a = a.replace(/މައި ގިންތި\t/g, "");
          a = a.replace(/ޒަމާން\t/g, "");
          a = a.replace(/އަދަބީ ގިންތި\t/g, "");
          a = a.replace(/ބަހުރުވަ\t/g, "");
          a = a.replace(/ދަރަޖަ\t/g, "");
          a = a.replace(/ދާއިރާ\t/g, "");
          a = a.replace(/އަތޮޅު\t/g, "");
          a = a.replace(/މިސާލު\t/g, "");
          a = a.replace(/ބާވަތް އިނގިރޭސިން\t/g, "");
          a = a.replace(/\t\t/g, "\t");
          return (a = a.replace(/\n\n\n\n|\n\n\n|\t|\s\s/g, "\n\n"));
        },
