$(document).ready(() => {
  ...
  const c = $("#nawawiTable").DataTable({
    data: nawawi_dataSet,
    columns: [
      { data: 0, title: "#" },
      { data: 1, title: "އަރަބި ސުރުހީ" },
      { data: 2, title: "ދިވެހި ސުރުހީ" },
      { data: 3, title: "އަރަބި ޙަދީޘް" },
      {
        data: 3,
      ...
      { data: 4, title: "ދިވެހި ތަރުޖަމާ" },
      { data: 5, title: "English" },
      { data: 6, title: "ތަޚްރީޖު އަރަބިން" },
      { data: 7, title: "ތަޚްރީޖު ދިވެހިން" },
      { data: 8, title: "ރިޔާޟުއްޞާލިޙީނުން" },
      { data: 9, title: "شرح العباد" },
      { data: 10, title: "شرح الخضير" },
    ],
    columnDefs: [
      {
        targets: [10, 11],
    ...
    buttons: [
      {
        ...
        customize(a) {
          ...
          a = a.replace(/\n/g, "\t");
          a = a.replace(/#\t/g, "");
          a = a.replace(/އަރަބި ސުރުހީ\t/g, "");
          a = a.replace(/ދިވެހި ސުރުހީ\t/g, "");
          a = a.replace(/އަރަބި ޙަދީޘް\t/g, "");
          a = a.replace(/އަރަބި ފިލިނުޖަހައި\t/g, "");
          a = a.replace(/ދިވެހި ތަރުޖަމާ\t/g, "");
          a = a.replace(/English\t/g, "");
          a = a.replace(/ތަޚްރީޖު އަރަބިން\t/g, "");
          a = a.replace(/ތަޚްރީޖު ދިވެހިން\t/g, "");
          a = a.replace(/ރިޔާޟުއްޞާލިޙީނުން\t/g, "");
          a = a.replace(/شرح العباد\t/g, "");
          a = a.replace(/شرح الخضير\t/g, "");
          a = a.replace(
            /\t‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾/g,
            "\n\n‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\n"
          );
