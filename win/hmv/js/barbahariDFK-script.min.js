$(document).ready(() => {
  ...
  const c = $("#akhbaruShuyukhTable").DataTable({
    data: akhbaruShuyukh_DB,
    columns: [
      {
        data: 0,
        title: "#",
      ...
      { data: 2, title: "އަރަބި ފުޓްނޯޓު" },
      { data: 3, title: "ދިވެހި ތަރުޖަމާ" },
      { data: 4, title: "ދިވެހި ފުޓްނޯޓު" },
    ],
    columnDefs: [
      {
        targets: [4],
