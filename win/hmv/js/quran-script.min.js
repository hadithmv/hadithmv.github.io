$(document).ready(() => {
  ...
  const c = $("#quranTable").DataTable({
    data: quran_dataSet,
    columns: [
      { data: 0, title: "ސޫރަތުގެ ނަން" },
      { data: 1, title: "ޖުޒް #" },
      { data: 2, title: "އާޔަތް #" },
      {
        data: 3,
    ...
    buttons: [
      {
        ...
        text: "ކޮޕީ",
        messageTop: "ޙަދީޘްއެމްވީ – ކީރިތި ޤުރްއާން",
        title: "",
        customize(a) {
          a = a.replace(/\r\n/g, "\t");
          a = a.replace(/\n/g, "\t");
          ...
          a = a.replace(/މުޖައްމާ ޤުރްއާން\t/g, "");
          a = a.replace(/ތަންޒީލު ޤުރްއާން\t/g, "");
          a = a.replace(/ފިލިނުޖަހާ ޤުރްއާން\t/g, "");
          a = a.replace(/ދިވެހި ތަރުޖަމާ\t/g, "");
          a = a.replace(/تفسير السعدي*\t/g, "");
          a = a.replace(/ތަފްސީރު އައްސަޢްދީ*\t/g, "");
          a = a.replace(/ބަކުރުބެގެ ލަފްޒީ ތަރުޖަމާ*\t/g, "");
          a = a.replace(/ބަކުރުބެގެ އިޖްމާލީ މާނަ*\t/g, "");
          a = a.replace(/\t\t/g, "\t");
          a = a.replace(/\t/g, "\n\n");
          a = a.replace(/\s\s/g, "\n\n");
          a = a.replace(/\n\n\n\n/g, "\n\n");
