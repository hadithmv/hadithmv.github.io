$(document).ready(() => {
  ...
  const d = $("#kunnaashaTable").DataTable({
    ...
    buttons: [
      {
        ...
        text: "ކޮޕީ",
        messageTop: "ޙަދީޘްއެމްވީ – ނޯޓުފޮތް",
        title: "",
        customize(a) {
          a = a.replace(/\r\n|\n/g, "\t");
          a = a.replace(/#\t/g, "");
          a = a.replace(/ސުރުހީ\t/g, "");
          a = a.replace(/ލިޔުންތެރިޔާ\t/g, "");
          a = a.replace(/ތާރީޚު\t/g, "");
          a = a.replace(/އަރަބި ލިޔުން\t/g, "");
          a = a.replace(/ލިޔުން\t/g, "");
          a = a.replace(/ލިޔުން ފިލިނުޖަހައި\t/g, "");
          a = a.replace(/މަސްދަރު\t/g, "");
          a = a.replace(/ލިންކު\t/g, "");
          a = a.replace(
            /\t‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾/g,
            "\n\n‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\n"
          );
